...
/* Vendored for a hermetic build: the platform availability annotations
   (`__API_AVAILABLE(...)`) carry no semantics for the API declarations, so
   define them away rather than pull in a platform header. */
