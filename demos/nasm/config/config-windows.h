...
/* HAVE_FSEEKO: off for the badc Windows CRT (no POSIX shim) */

/* Define to 1 if you have the `fstat' function. */
#define HAVE_FSTAT 1

/* Define to 1 if you have the `ftruncate' function. */
/* HAVE_FTRUNCATE: off for the badc Windows CRT (no POSIX shim) */
...
/* HAVE_FUNC_ATTRIBUTE_ERROR: off; badc ignores attribute(error) */
...
/* HAVE_GETPAGESIZE: off for the badc Windows CRT (no POSIX shim) */
...
/* HAVE_MMAP: off for the badc Windows CRT (no POSIX shim) */

/* Define to 1 if you have the `pathconf' function. */
#define HAVE_PATHCONF 1

/* Define to 1 if you have the `realpath' function. */
/* HAVE_REALPATH: off for the badc Windows CRT (no POSIX shim) */
