...
#define EDQUOT          122
#define EILSEQ          84
// Remaining Linux errno numbers (asm-generic/errno.h), so <errno.h>
// exposes every E* the kernel and glibc define. EWOULDBLOCK is aliased
// to EAGAIN below; EOVERFLOW / EILSEQ / EUSERS / the socket block /
// EDQUOT are already defined above and are not repeated here.
#define ENOMSG          42
#define EIDRM           43
#define ECHRNG          44
#define EL2NSYNC        45
