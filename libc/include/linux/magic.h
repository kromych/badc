// linux/magic.h -- filesystem superblock magic numbers from the kernel
// uapi header. Returned in statfs::f_type; consumers switch on these to
...
#define CRAMFS_MAGIC_WEND      0x453dcd28  /* magic with the wrong endianess */
...
#define MINIX3_SUPER_MAGIC     0x4d5a  /* minix v3, 60 char names */
