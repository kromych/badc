// linux/parport.h -- parallel-port constants from the kernel uapi header:
// control/status register bits, IEEE 1284 transfer modes, and the device
// class enumeration. Used alongside <linux/ppdev.h>.
