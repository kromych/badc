...
impl Vm {
    ...
    fn read_size(&self, addr: usize, name: &str) -> Result<usize, C4Error> {
    ...
    // Syscalls.
    //
    // Each library function (`malloc`, `printf`, `mprotect`, …) is one
    // method here, called from a one-line arm in the dispatch loop:
    //
    //     Op::Open => a = self.syscall_open(sp)?,
    //
    // The return value goes into the accumulator; runtime errors (bad
    // size, double free, …) propagate via `?`. Splitting them out
    // shrinks `run` from ~440 to ~200 lines, gives each syscall room
    // for its own rustdoc, and makes the host-call surface scannable
    // at a glance.
    // ============================================================
    ...
    fn syscall_open(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    /// `open()`.
    fn syscall_read(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    fn syscall_close(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    fn syscall_malloc(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    fn syscall_free(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    fn syscall_memset(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    fn syscall_memcmp(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    /// overlap.
    fn syscall_memcpy(&mut self, sp: usize) -> Result<i64, C4Error> {
        let dst_addr = self.load_i64(sp + 16)? as usize;
    ...
    /// of `--track-pointers`.
    fn syscall_mprotect(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    fn syscall_printf(&mut self, sp: usize, pc: usize) -> Result<i64, C4Error> {
    ...
    fn syscall_write(&mut self, sp: usize) -> Result<i64, C4Error> {
        let fd = self.load_i64(sp + 16)?;
        let buf_addr = self.load_i64(sp + 8)? as usize;
    ...
    fn syscall_getenv(&mut self, sp: usize) -> Result<i64, C4Error> {
    ...
    fn syscall_setenv(&mut self, sp: usize) -> Result<i64, C4Error> {
