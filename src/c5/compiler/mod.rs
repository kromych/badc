...
use types::{
    ...
    is_floating_scalar, is_pointer_ty, is_scalar_load_op_val, is_struct_ty, is_unsigned_ty,
    load_op_for, reemit_scalar_load, store_op_for, struct_id_of, struct_ptr_depth, struct_ty_for,
