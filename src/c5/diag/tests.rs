...
fn the_named_codes_match_their_rows() {
    for (code, name) in [
        ...
        (Code::STATIC_ASSERT, "static-assert"),
        (Code::INVALID_OPERANDS, "invalid-operands"),
        (Code::CONSTANT_EXPRESSION, "constant-expression"),
        (Code::INVALID_INITIALIZER, "invalid-initializer"),
        ...
        (Code::CONTROLLING_EXPRESSION, "controlling-expression"),
