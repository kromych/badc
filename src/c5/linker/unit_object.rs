...
fn encode_meta(unit: &LinkUnit) -> Vec<u8> {
    ...
    }
    {
        ...
        for v in &unit.variables {
            ...
            write_u32(&mut buf, v.array_size);
            write_u32(&mut buf, v.decl_file);
        }
    }
    {
        ...
        match tag {
            ...
            TAG_VARIABLES => {
                ...
                for _ in 0..n {
                    ...
                    let array_size = u32_at(body, local + 21);
                    let decl_file = u32_at(body, local + 25);
                    local += 29;
