...
pub(super) const NATIVE_FIXTURES: &[(&str, i32)] = &[
    ...
    ("section_static_table_dead_cascade.c", 0),
    ...
    ("block_lifetime_storage.c", 0),
    ("aggregate_built_in_place.c", 0),
    ("arrays_basic.c", 0),
    ...
    ("strength_reduce_compound_divmod.c", 0),
    ("strength_reduce_inlined_divmod.c", 0),
    ...
    ("perf_loop_shapes.c", 0),
    ("mem2reg_call_ref_rekey.c", 0),
    ...
    ("computed_goto_dispatch_phis.c", 0),
    ...
    ("hfa_element_count.c", 0),
    ("sysv_eightbyte_classes.c", 0),
    ("homogeneous_vector_aggregates.c", 0),
    ("sysv_misaligned_members.c", 0),
    ("naked_callee_pointer_argument.c", 0),
    ("by_reference_arguments.c", 0),
    ("small_fp_aggregate_arguments.c", 0),
    ("sysv_x87_unions.c", 0),
    ("variadic_sysv_eightbytes.c", 0),
    ("aggregate_result_alignment.c", 0),
    ("bitfield_assign_value.c", 0),
    ("bool_bitfield_assign_normalizes.c", 0),
    ...
    ("many_fp_args.c", 0),
    ("fp_volatile_bank_across_calls.c", 0),
    ...
    ("member_store_constant_readback.c", 0),
    ("store_bounds_readback.c", 0),
    ("inline_nested_aggregate_return.c", 0),
    ...
    ("const_object_member_fold.c", 0),
    ("typedef_name_label.c", 0),
    ...
    ("pointer_to_array_of_function_pointers.c", 0),
    ("generic_function_types.c", 0),
    ("function_returning_pointer_to_array.c", 0),
...
pub(super) const NATIVE_ELF_FIXTURES: &[(&str, i32)] = &[
    ...
    ("printf_float.c", 0),
    // AAPCS64 returns binary128 in v0, which the caller stores whole and
    // reads back as its image; read as d0, `strtold` lands at 0.0 for any
    // power-of-two value (mantissa zero, the exponent in v0's high half).
