...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ("ret42", "linux-x64", 0x8ef58e55e1d508e9, 968),
    ("ret42", "linux-arm64", 0x4bc4516bb78970ac, 1024),
    ("ret42", "macos-arm64", 0x4bc4516bb78970ac, 1024),
    ("ret42", "win-x64", 0x8ef58e55e1d508e9, 968),
    ("ret42", "win-arm64", 0x4bc4516bb78970ac, 1024),
    ("intarith", "linux-x64", 0x1b0dbf4d6efff9fb, 1248),
    ("intarith", "linux-arm64", 0x83042354ae94c8ad, 1264),
    ("intarith", "macos-arm64", 0x83042354ae94c8ad, 1264),
    ("intarith", "win-x64", 0x77e7f6dc7e641481, 1280),
    ("intarith", "win-arm64", 0x00b13670e0ba7f66, 1312),
    ("fparith", "linux-x64", 0xb5af73b6e47d2b8b, 1224),
    ("fparith", "linux-arm64", 0x3d51d1ae7a19379d, 1208),
    ("fparith", "macos-arm64", 0x3d51d1ae7a19379d, 1208),
    ("fparith", "win-x64", 0x65e6f545e5da2431, 1312),
    ("fparith", "win-arm64", 0x3d51d1ae7a19379d, 1208),
    ("fpunary", "linux-x64", 0x8c3362f0517b4cc0, 1288),
    ("fpunary", "linux-arm64", 0x6d32035d796d0d70, 1256),
    ("fpunary", "macos-arm64", 0x6d32035d796d0d70, 1256),
    ("fpunary", "win-x64", 0xa4c6b0deb89d629d, 1424),
    ("fpunary", "win-arm64", 0x6d32035d796d0d70, 1256),
    ("mem", "linux-x64", 0xd324aa915d4f6025, 1104),
    ("mem", "linux-arm64", 0x9a0bb3a48f4c323f, 1152),
    ("mem", "macos-arm64", 0x9a0bb3a48f4c323f, 1152),
    ("mem", "win-x64", 0xc8657dd00a946545, 1104),
    ("mem", "win-arm64", 0x9a0bb3a48f4c323f, 1152),
    ("data_calls", "linux-x64", 0x907d0abf620be327, 1248),
    ("data_calls", "linux-arm64", 0x2123f169a6438e5c, 1320),
    ("data_calls", "macos-arm64", 0x2123f169a6438e5c, 1320),
    ("data_calls", "win-x64", 0x0cce776e45a4127d, 1256),
    ("data_calls", "win-arm64", 0x2123f169a6438e5c, 1320),
    ("struct_param_spill", "linux-x64", 0x0e71378f5b649f99, 1176),
    (
        "struct_param_spill",
        "linux-arm64",
        0x6ec10c60a2011ccd,
    ...
    ("struct_param_spill", "win-x64", 0xdc2ca6e9290b4a12, 1216),
    ("struct_param_spill", "win-arm64", 0x44e52175d34497dc, 1256),
    (
    ...
    ("fp_across_struct_call", "win-x64", 0x7623cf891e53b3f7, 1376),
    (
        "fp_across_struct_call",
        "win-arm64",
        0x15634c7eaee34149,
