...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ...
    ("intarith", "win-arm64", 0x726ac0c15636680b, 1256),
    ...
    ("data_calls", "linux-arm64", 0x620aac3c7b954f46, 1288),
    ("data_calls", "macos-arm64", 0x620aac3c7b954f46, 1288),
    ("data_calls", "win-x64", 0x9fe8aea6a47d6d5a, 1152),
    ("data_calls", "win-arm64", 0x620aac3c7b954f46, 1288),
    ...
    ("struct_param_spill", "win-arm64", 0xfae422d11b7b6128, 1200),
    (
