...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ...
    ("intarith", "win-x64", 0xa2b7a7ed6a058395, 1136),
    ...
    ("struct_param_spill", "win-x64", 0x4afa35c5886dc52e, 1032),
