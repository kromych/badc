...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ("ret42", "linux-x64", 0xa9c144e4555f661b, 1544),
    ("ret42", "linux-arm64", 0x998f69a7182acae0, 1544),
    ("ret42", "macos-arm64", 0x998f69a7182acae0, 1544),
    ("ret42", "win-x64", 0xa9c144e4555f661b, 1544),
    ("ret42", "win-arm64", 0x998f69a7182acae0, 1544),
    ("intarith", "linux-x64", 0xd424d26b027d99fe, 1848),
    ("intarith", "linux-arm64", 0x531e6e2ed7f4e7df, 1816),
    ("intarith", "macos-arm64", 0x531e6e2ed7f4e7df, 1816),
    ("intarith", "win-x64", 0xc1dc3c3c243ff25c, 1880),
    ("intarith", "win-arm64", 0x0a23bd0bc3f2c974, 1864),
    ("fparith", "linux-x64", 0x3b096b3e65e84e65, 1824),
    ("fparith", "linux-arm64", 0xe70d2dad5d180b58, 1760),
    ("fparith", "macos-arm64", 0xe70d2dad5d180b58, 1760),
    ("fparith", "win-x64", 0x72e937ba4efce275, 1912),
    ("fparith", "win-arm64", 0xe70d2dad5d180b58, 1760),
    ("fpunary", "linux-x64", 0x95a2c21afa55b4a6, 1920),
    ("fpunary", "linux-arm64", 0x65d9061cfdc56cea, 1832),
    ("fpunary", "macos-arm64", 0x65d9061cfdc56cea, 1832),
    ("fpunary", "win-x64", 0x43e5dcc07b54ab3d, 2056),
    ("fpunary", "win-arm64", 0x65d9061cfdc56cea, 1832),
    ("mem", "linux-x64", 0xe69085d2f7957eff, 1680),
    ("mem", "linux-arm64", 0x903a8f145444d856, 1680),
    ("mem", "macos-arm64", 0x903a8f145444d856, 1680),
    ("mem", "win-x64", 0xfc3d412b8b9d301f, 1680),
    ("mem", "win-arm64", 0x903a8f145444d856, 1680),
    ("data_calls", "linux-x64", 0x6946f908fd6e6305, 1744),
    ("data_calls", "linux-arm64", 0x71a9161bb404f3a9, 1768),
    ("data_calls", "macos-arm64", 0x71a9161bb404f3a9, 1768),
    ("data_calls", "win-x64", 0x5bf810a2c094a872, 1752),
    ("data_calls", "win-arm64", 0x71a9161bb404f3a9, 1768),
    ("struct_param_spill", "linux-x64", 0x8790d0f4ed460ffd, 1752),
    (
        "struct_param_spill",
        "linux-arm64",
        0x6ce5338332801ae6,
    ...
    ("struct_param_spill", "win-x64", 0xb51d76ac3f36ac41, 1792),
    ("struct_param_spill", "win-arm64", 0x4ce914ff85832d93, 1776),
    (
    ...
    ("fp_across_struct_call", "win-x64", 0xc553dbf0e3285119, 1880),
    (
        "fp_across_struct_call",
        "win-arm64",
        0xd5075ab660c3d0a6,
