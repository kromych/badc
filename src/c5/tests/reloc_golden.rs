...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ...
    ("intarith", "win-x64", 0xce334da095e78d47, 1080),
    ("intarith", "win-arm64", 0xcf4ce04b61fd63f4, 1240),
    ("fparith", "linux-x64", 0x1d91a65f6ace0059, 1048),
    ("fparith", "linux-arm64", 0xd0a30bf0e45d9378, 1160),
    ("fparith", "macos-arm64", 0xd0a30bf0e45d9378, 1160),
    ("fparith", "win-x64", 0x13037fc21595ab72, 1096),
    ("fparith", "win-arm64", 0xd0a30bf0e45d9378, 1160),
    ("fpunary", "linux-x64", 0xd6a5cd90035961af, 1096),
    ("fpunary", "linux-arm64", 0x5b5a41d43c2c6410, 1200),
    ("fpunary", "macos-arm64", 0x5b5a41d43c2c6410, 1200),
    ("fpunary", "win-x64", 0xab04e2b4e6966518, 1160),
    ("fpunary", "win-arm64", 0x5b5a41d43c2c6410, 1200),
    ("mem", "linux-x64", 0xf73cef702807d75a, 968),
    ("mem", "linux-arm64", 0x5e5a6a9dca5f2e57, 1120),
    ("mem", "macos-arm64", 0x5e5a6a9dca5f2e57, 1120),
    ("mem", "win-x64", 0xdf3b3b92f196e92a, 968),
    ("mem", "win-arm64", 0x5e5a6a9dca5f2e57, 1120),
    ("data_calls", "linux-x64", 0xf451ae75240b3d0c, 1136),
    ("data_calls", "linux-arm64", 0xea1382048cea3d98, 1280),
    ("data_calls", "macos-arm64", 0xea1382048cea3d98, 1280),
    ("data_calls", "win-x64", 0x2b7cd7c0fa84189f, 1136),
    ("data_calls", "win-arm64", 0xea1382048cea3d98, 1280),
    ...
    ("fp_across_struct_call", "win-x64", 0x89c3383854c129d2, 1160),
    (
        "fp_across_struct_call",
        "win-arm64",
        0xdc8f1a22b82d4da4,
