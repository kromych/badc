...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ...
    ("intarith", "win-x64", 0x73db610580e195fa, 1808),
    ...
    ("struct_param_spill", "win-x64", 0x4b47faceeb45bc69, 1720),
