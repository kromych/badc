...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ("ret42", "linux-x64", 0x2769e5c920d8338c, 880),
    ("ret42", "linux-arm64", 0x9478d0bfca53acfe, 1008),
    ("ret42", "macos-arm64", 0x9478d0bfca53acfe, 1008),
    ("ret42", "win-x64", 0x2769e5c920d8338c, 880),
    ("ret42", "win-arm64", 0x9478d0bfca53acfe, 1008),
    ("intarith", "linux-x64", 0x8bba7244c987dc1c, 1152),
    ("intarith", "linux-arm64", 0x105a397d1268dcfb, 1248),
    ("intarith", "macos-arm64", 0x105a397d1268dcfb, 1248),
    ("intarith", "win-x64", 0xac2128b8388b67df, 1184),
    ("intarith", "win-arm64", 0x77a740cdb74cff9c, 1296),
    ("fparith", "linux-x64", 0x8c41b81bc6e1d419, 1128),
    ("fparith", "linux-arm64", 0x923c7f04869efd63, 1192),
    ("fparith", "macos-arm64", 0x923c7f04869efd63, 1192),
    ("fparith", "win-x64", 0xf4cd03404b128037, 1216),
    ("fparith", "win-arm64", 0x923c7f04869efd63, 1192),
    ("fpunary", "linux-x64", 0xa0ca7e291afe839a, 1200),
    ("fpunary", "linux-arm64", 0x69ff42a7669423c2, 1232),
    ("fpunary", "macos-arm64", 0x69ff42a7669423c2, 1232),
    ("fpunary", "win-x64", 0x493d7a831e873673, 1336),
    ("fpunary", "win-arm64", 0x69ff42a7669423c2, 1232),
    ("mem", "linux-x64", 0x7dd885de8cc5d73e, 1008),
    ("mem", "linux-arm64", 0xfeb743f411437abd, 1136),
    ("mem", "macos-arm64", 0xfeb743f411437abd, 1136),
    ("mem", "win-x64", 0xe37a1ba2b227d37e, 1008),
    ("mem", "win-arm64", 0xfeb743f411437abd, 1136),
    ("data_calls", "linux-x64", 0x14da60bfb3b9c184, 1176),
    ("data_calls", "linux-arm64", 0xf765a8339663fc2e, 1304),
    ("data_calls", "macos-arm64", 0xf765a8339663fc2e, 1304),
    ...
    ("fp_across_struct_call", "win-x64", 0x33abd8790e2fb7fa, 1280),
    (
        "fp_across_struct_call",
        "win-arm64",
        0x3e0a6b93b15cd32b,
