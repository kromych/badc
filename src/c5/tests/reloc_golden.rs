...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ...
    ("data_calls", "win-x64", 0x50cfae75d56de60e, 1680),
    ("data_calls", "win-arm64", 0x235c643dd72092b4, 1696),
    ("struct_param_spill", "linux-x64", 0x7b986ab0ca23cfb3, 1680),
    (
        "struct_param_spill",
        "linux-arm64",
        0x60a2bcd6ef88226d,
    ...
    ("struct_param_spill", "win-x64", 0x7bde041dbe4d8f45, 1720),
    ...
    ("fp_across_struct_call", "win-x64", 0xe7036869f603f7f3, 1808),
    (
        "fp_across_struct_call",
        "win-arm64",
        0x55ce18cc6a27bed5,
