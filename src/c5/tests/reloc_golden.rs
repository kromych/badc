...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ...
    ("data_calls", "linux-x64", 0xf82cb400d50e74ef, 1672),
    ("data_calls", "linux-arm64", 0x89f87f33bc6132dd, 1688),
    ("data_calls", "macos-arm64", 0x89f87f33bc6132dd, 1688),
    ("data_calls", "win-x64", 0xdf9bc43fe6620521, 1680),
    ("data_calls", "win-arm64", 0x89f87f33bc6132dd, 1688),
