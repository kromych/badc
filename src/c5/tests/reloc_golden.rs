...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ...
    ("intarith", "linux-x64", 0x41e12caa2cab3ca7, 1112),
    ("intarith", "linux-arm64", 0x1ae9ffd86412281e, 1248),
    ("intarith", "macos-arm64", 0x1ae9ffd86412281e, 1248),
    ("intarith", "win-x64", 0x4724edab5b8654d0, 1104),
    ("intarith", "win-arm64", 0x992a593aa3447079, 1256),
    ("fparith", "linux-x64", 0x7d660e97c2572837, 1104),
    ("fparith", "linux-arm64", 0xeafb11cbcd782f10, 1208),
    ("fparith", "macos-arm64", 0xeafb11cbcd782f10, 1208),
    ("fparith", "win-x64", 0x787fc338769b4f73, 1176),
    ("fparith", "win-arm64", 0xeafb11cbcd782f10, 1208),
    ("fpunary", "linux-x64", 0xdb365a0e74baa412, 1160),
    ("fpunary", "linux-arm64", 0xab9841afe753812e, 1264),
    ("fpunary", "macos-arm64", 0xab9841afe753812e, 1264),
    ("fpunary", "win-x64", 0x7d6a255f87088706, 1272),
    ("fpunary", "win-arm64", 0xab9841afe753812e, 1264),
    ("mem", "linux-x64", 0x2cc5aa98b2074ed1, 976),
    ("mem", "linux-arm64", 0x4b264a3ce3726a3f, 1136),
    ("mem", "macos-arm64", 0x4b264a3ce3726a3f, 1136),
    ("mem", "win-x64", 0x0319c89406d18a79, 976),
    ("mem", "win-arm64", 0x4b264a3ce3726a3f, 1136),
    ("data_calls", "linux-x64", 0x1021c645efedc606, 1144),
    ("data_calls", "linux-arm64", 0xf6f8e8a6aaf7fb31, 1288),
    ("data_calls", "macos-arm64", 0xf6f8e8a6aaf7fb31, 1288),
    ("data_calls", "win-x64", 0x9fe8aea6a47d6d5a, 1152),
    ("data_calls", "win-arm64", 0xf6f8e8a6aaf7fb31, 1288),
    ("struct_param_spill", "linux-x64", 0x78906aa615520016, 1024),
    (
        "struct_param_spill",
        "linux-arm64",
        0x9c839aa00b4b58d3,
    ...
    ("struct_param_spill", "win-x64", 0xef39fd90d100179f, 1008),
    ("struct_param_spill", "win-arm64", 0x1e633fec0a69bf22, 1192),
    (
    ...
    ("fp_across_struct_call", "win-x64", 0xf386d1f46888d9b0, 1256),
    (
        "fp_across_struct_call",
        "win-arm64",
        0x0e3f0c269edb5fd9,
