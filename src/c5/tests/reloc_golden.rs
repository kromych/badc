...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ("ret42", "linux-x64", 0x21b3df76f36b43a7, 1248),
    ("ret42", "linux-arm64", 0x0e88d31fb1f4267b, 1304),
    ("ret42", "macos-arm64", 0x0e88d31fb1f4267b, 1304),
    ("ret42", "win-x64", 0x21b3df76f36b43a7, 1248),
    ("ret42", "win-arm64", 0x0e88d31fb1f4267b, 1304),
    ("intarith", "linux-x64", 0x0bf6eeee56b3c164, 1520),
    ("intarith", "linux-arm64", 0xd1e4032d1ea366aa, 1544),
    ("intarith", "macos-arm64", 0xd1e4032d1ea366aa, 1544),
    ("intarith", "win-x64", 0xd9b42e9246867475, 1552),
    ("intarith", "win-arm64", 0x5a1e9c414c3e8995, 1592),
    ("fparith", "linux-x64", 0x6097b0a18fae34fc, 1496),
    ("fparith", "linux-arm64", 0xd42f1bfb6f097ef9, 1488),
    ("fparith", "macos-arm64", 0xd42f1bfb6f097ef9, 1488),
    ("fparith", "win-x64", 0x018cc44293a4de65, 1584),
    ("fparith", "win-arm64", 0xd42f1bfb6f097ef9, 1488),
    ("fpunary", "linux-x64", 0xa987d60726538619, 1568),
    ("fpunary", "linux-arm64", 0x08187fa3722946d3, 1536),
    ("fpunary", "macos-arm64", 0x08187fa3722946d3, 1536),
    ("fpunary", "win-x64", 0x68757ab28cc73c76, 1704),
    ("fpunary", "win-arm64", 0x08187fa3722946d3, 1536),
    ("mem", "linux-x64", 0xd91e36679fcbfa17, 1376),
    ("mem", "linux-arm64", 0xfc5f5f7cfdfba109, 1432),
    ("mem", "macos-arm64", 0xfc5f5f7cfdfba109, 1432),
    ("mem", "win-x64", 0xdf426aa54808b617, 1376),
    ("mem", "win-arm64", 0xfc5f5f7cfdfba109, 1432),
    ("data_calls", "linux-x64", 0xe74bda1ea1bca48a, 1520),
    ("data_calls", "linux-arm64", 0x8fc8b49c593d9c54, 1600),
    ("data_calls", "macos-arm64", 0x8fc8b49c593d9c54, 1600),
    ("data_calls", "win-x64", 0x4f1820c776b12d71, 1528),
    ("data_calls", "win-arm64", 0x8fc8b49c593d9c54, 1600),
    ("struct_param_spill", "linux-x64", 0x757761257dcbe27b, 1456),
    (
        "struct_param_spill",
        "linux-arm64",
        0x172bc422275b14aa,
    ...
    ("struct_param_spill", "win-x64", 0xeacf132c5629b5ad, 1496),
    ("struct_param_spill", "win-arm64", 0x645d8ca94f7c3a9d, 1536),
    (
    ...
    ("fp_across_struct_call", "win-x64", 0x377d5418c0a5a888, 1656),
    (
        "fp_across_struct_call",
        "win-arm64",
        0x7c521352e1e18c6e,
