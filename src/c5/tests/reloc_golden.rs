...
const GOLDEN: &[(&str, &str, u64, usize)] = &[
    ...
    ("ret42", "linux-arm64", 0x2c6932f07eb7d5c8, 1248),
    ("ret42", "macos-arm64", 0x2c6932f07eb7d5c8, 1248),
    ("ret42", "win-x64", 0x21b3df76f36b43a7, 1248),
    ("ret42", "win-arm64", 0x2c6932f07eb7d5c8, 1248),
    ("intarith", "linux-x64", 0x0bf6eeee56b3c164, 1520),
    ("intarith", "linux-arm64", 0x9da4ac82b02a9f34, 1488),
    ("intarith", "macos-arm64", 0x9da4ac82b02a9f34, 1488),
    ("intarith", "win-x64", 0xd9b42e9246867475, 1552),
    ("intarith", "win-arm64", 0xd1a111fa67dea68c, 1536),
    ("fparith", "linux-x64", 0x6097b0a18fae34fc, 1496),
    ("fparith", "linux-arm64", 0x4792ec9e74fd2d7c, 1432),
    ("fparith", "macos-arm64", 0x4792ec9e74fd2d7c, 1432),
    ("fparith", "win-x64", 0x018cc44293a4de65, 1584),
    ("fparith", "win-arm64", 0x4792ec9e74fd2d7c, 1432),
    ("fpunary", "linux-x64", 0xa987d60726538619, 1568),
    ("fpunary", "linux-arm64", 0x5d38ccd50678ec31, 1480),
    ("fpunary", "macos-arm64", 0x5d38ccd50678ec31, 1480),
    ("fpunary", "win-x64", 0x68757ab28cc73c76, 1704),
    ("fpunary", "win-arm64", 0x5d38ccd50678ec31, 1480),
    ("mem", "linux-x64", 0xd91e36679fcbfa17, 1376),
    ("mem", "linux-arm64", 0x78aac0ea2a1017ca, 1376),
    ("mem", "macos-arm64", 0x78aac0ea2a1017ca, 1376),
    ("mem", "win-x64", 0xdf426aa54808b617, 1376),
    ("mem", "win-arm64", 0x78aac0ea2a1017ca, 1376),
    ("data_calls", "linux-x64", 0xe74bda1ea1bca48a, 1520),
    ("data_calls", "linux-arm64", 0xb779e583d0d69e67, 1544),
    ("data_calls", "macos-arm64", 0xb779e583d0d69e67, 1544),
    ("data_calls", "win-x64", 0x4f1820c776b12d71, 1528),
    ("data_calls", "win-arm64", 0xb779e583d0d69e67, 1544),
    ...
    ("struct_param_spill", "win-arm64", 0xf64d60e8bfe6e564, 1480),
    (
