...
pub use c5::{
    C5Error, CodeModel, CompileOptions, Compiler, Hardening, Host, IndirectBranch, NativeOptions,
    OutputKind, Overwrite, PredefinedKind, PredefinedSymbol, Program, Target, Trace, VariableInfo,
    Vm, embedded_headers, jit_run, jit_run_with_options, predefined_symbols,
};
...
pub use c5::{
    ...
    parse_native_elf, parse_shared_library, read_archive_at, render_link_map,
