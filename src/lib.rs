...
pub use c5::{
    ...
    is_ld_invocation, is_mach_o_fat, is_mach_o_object, is_native_object, link_native_objects,
    ...
    parse_linker_script, parse_native_elf, parse_native_mach_o, parse_native_object,
