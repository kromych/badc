...
<.text>:
               	...
               	mov	x0, #0x0                // =0
               	stur	w0, [x29, #-0x10]
               	b	0x4004b8 <.text+0x1b8>
               	ldursw	x0, [x29, #-0x10]
               	cmp	x0, #0x20
               	b.ge	0x40050c <.text+0x20c>
               	b	0x4004dc <.text+0x1dc>
               	sub	x22, x29, #0x10
               	ldrsw	x0, [x22]
               	add	x0, x0, #0x1
               	str	w0, [x22]
               	...
               	and	x21, x21, x17
               	cmp	x21, #0x0
               	b.eq	0x400558 <.text+0x258>
               	b	0x400534 <.text+0x234>
               	mov	x21, #0x0               // =0
               	mov	x0, x21
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
               	...
               	ldursw	x15, [x29, #0x10]
               	cmp	x14, x15
               	b.ge	0x400610 <.text+0x310>
               	b	0x4005e4 <.text+0x2e4>
               	sub	x15, x29, #0x10
               	ldrsw	x14, [x15]
               	add	x14, x14, #0x1
               	str	w14, [x15]
               	...
               	mov	x13, #0x0               // =0
               	stur	w13, [x29, #-0x10]
               	b	0x40061c <.text+0x31c>
               	ldursw	x13, [x29, #-0x10]
               	ldursw	x15, [x29, #0x10]
               	cmp	x13, x15
               	b.ge	0x40066c <.text+0x36c>
               	b	0x400644 <.text+0x344>
               	sub	x15, x29, #0x10
               	ldrsw	x13, [x15]
               	add	x13, x13, #0x1
               	str	w13, [x15]
