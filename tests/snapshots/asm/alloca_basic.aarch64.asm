...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x4073ec <exit+0x64f0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f947c
               	tbz	w21, #0x6, 0x3ff440
               	<unknown>
               	cbnz	w16, 0x46f3e8
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x4009f4 <.text+0x6f4>
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x4074b4 <exit+0x65b8>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9544
               	tbz	w21, #0x6, 0x3ff508
               	<unknown>
               	cbnz	w16, 0x46f4b0
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x400abc <.text+0x7bc>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
