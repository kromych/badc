...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400ea2 <.text+0xba2>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400e99 <.text+0xb99>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400e9d <.text+0xb9d>
               	andb	%ch, 0x74(%rax)
               	je	0x400ead <.text+0xbad>
               	jae	0x400e79 <.text+0xb79>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400f62 <exit+0x29>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400f59 <exit+0x20>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400f5d <exit+0x24>
               	andb	%ch, 0x74(%rax)
               	je	0x400f6d <exit+0x34>
               	jae	0x400f39 <exit>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
...
<dlsym>:
               	jmpq	*0xf1b3(%rip)           # 0x4100e0

<memset>:
               	jmpq	*0xf1b5(%rip)           # 0x4100e8

<printf>:
               	jmpq	*0xf1b7(%rip)           # 0x4100f0

<exit>:
               	jmpq	*0xf1b9(%rip)           # 0x4100f8
