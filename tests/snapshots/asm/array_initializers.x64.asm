...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400b0e <.text+0x8ee>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400b05 <.text+0x8e5>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400b09 <.text+0x8e9>
               	andb	%ch, 0x74(%rax)
               	je	0x400b19 <.text+0x8f9>
               	jae	0x400ae5 <.text+0x8c5>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400bd2 <exit+0x3b>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400bc9 <exit+0x32>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400bcd <exit+0x36>
               	andb	%ch, 0x74(%rax)
               	je	0x400bdd <exit+0x46>
               	jae	0x400ba9 <exit+0x12>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
