...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4005e6 <.text+0x326>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4005dd <.text+0x31d>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4005e1 <.text+0x321>
               	andb	%ch, 0x74(%rax)
               	je	0x4005f1 <.text+0x331>
               	jae	0x4005bd <.text+0x2fd>
               	<unknown>
               	<unknown>
