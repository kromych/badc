...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40062e <.text+0x36e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400625 <.text+0x365>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400629 <.text+0x369>
               	andb	%ch, 0x74(%rax)
               	je	0x400639 <.text+0x379>
               	jae	0x400605 <.text+0x345>
               	<unknown>
               	<unknown>
