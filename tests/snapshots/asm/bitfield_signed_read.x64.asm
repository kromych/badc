...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40083e <.text+0x61e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400835 <.text+0x615>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400839 <.text+0x619>
               	andb	%ch, 0x74(%rax)
               	je	0x400849 <.text+0x629>
               	jae	0x400815 <.text+0x5f5>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400902 <exit+0x3b>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4008f9 <exit+0x32>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4008fd <exit+0x36>
               	andb	%ch, 0x74(%rax)
               	je	0x40090d <exit+0x46>
               	jae	0x4008d9 <exit+0x12>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
