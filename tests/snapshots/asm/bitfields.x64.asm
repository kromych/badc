...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400a0e <.text+0x7de>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400a05 <.text+0x7d5>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400a09 <.text+0x7d9>
               	andb	%ch, 0x74(%rax)
               	je	0x400a19 <.text+0x7e9>
               	jae	0x4009e5 <.text+0x7b5>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400ad2 <exit+0x3b>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400ac9 <exit+0x32>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400acd <exit+0x36>
               	andb	%ch, 0x74(%rax)
               	je	0x400add <exit+0x46>
               	jae	0x400aa9 <exit+0x12>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
