...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4072fe <.text+0x6e9e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4072f5 <.text+0x6e95>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4072f9 <.text+0x6e99>
               	andb	%ch, 0x74(%rax)
               	je	0x407309 <.text+0x6ea9>
               	jae	0x4072d5 <.text+0x6e75>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4073c2 <free+0x5>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4073b9 <close+0x2>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4073bd <free>
               	andb	%ch, 0x74(%rax)
               	je	0x4073cd <free+0x10>
               	jae	0x407399 <exit>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
...
<dlsym>:
               	jmpq	*0x8d53(%rip)           # 0x4100e0

<printf>:
               	jmpq	*0x8d55(%rip)           # 0x4100e8

<memcmp>:
               	jmpq	*0x8d57(%rip)           # 0x4100f0

<exit>:
               	jmpq	*0x8d59(%rip)           # 0x4100f8

<open>:
               	jmpq	*0x8d5b(%rip)           # 0x410100

<malloc>:
               	jmpq	*0x8d5d(%rip)           # 0x410108

<memset>:
               	jmpq	*0x8d5f(%rip)           # 0x410110

<read>:
               	jmpq	*0x8d61(%rip)           # 0x410118

<close>:
               	jmpq	*0x8d63(%rip)           # 0x410120

<free>:
               	jmpq	*0x8d65(%rip)           # 0x410128
