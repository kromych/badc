...
<.text>:
               	...
               	cset	x15, eq
               	cmp	x15, #0x0
               	b.ne	0x400540 <.text+0x240>
               	b	0x4004f0 <.text+0x1f0>
               	mov	x22, #0x0               // =0
               	cbnz	x22, 0x4004a4 <.text+0x1a4>
               	mov	x0, #0x0                // =0
               	mov	x17, #0xffff            // =65535
               	movk	x17, #0xffff, lsl #16
               	and	x0, x0, x17
               	...
               	cset	x0, eq
               	cmp	x0, #0x0
               	b.ne	0x4005f8 <.text+0x2f8>
               	b	0x4005ac <.text+0x2ac>
               	mov	x20, #0x0               // =0
               	cbnz	x20, 0x400544 <.text+0x244>
               	mov	x0, #0xffff             // =65535
               	...
               	cset	x0, eq
               	cmp	x0, #0x0
               	b.ne	0x4006b4 <.text+0x3b4>
               	b	0x400664 <.text+0x364>
               	mov	x23, #0x0               // =0
               	cbnz	x23, 0x4005fc <.text+0x2fc>
               	mov	x0, #0xffff             // =65535
               	movk	x0, #0xffff, lsl #16
               	movk	x0, #0xffff, lsl #32
               	movk	x0, #0xffff, lsl #48
               	...
               	cset	x0, eq
               	cmp	x0, #0x0
               	b.ne	0x400750 <.text+0x450>
               	b	0x400700 <.text+0x400>
               	mov	x26, #0x0               // =0
               	cbnz	x26, 0x4006b8 <.text+0x3b8>
               	mov	x0, #0xc350             // =50000
               	mov	x17, #0xffff            // =65535
               	and	x0, x0, x17
               	mul	x0, x0, x0
               	...
               	cset	x0, eq
               	cmp	x0, #0x0
               	b.ne	0x400808 <.text+0x508>
               	b	0x4007b8 <.text+0x4b8>
               	mov	x24, #0x0               // =0
               	cbnz	x24, 0x400754 <.text+0x454>
               	mov	x0, #0xffff             // =65535
               	movk	x0, #0xffff, lsl #16
               	movk	x0, #0xffff, lsl #32
               	movk	x0, #0xffff, lsl #48
               	...
               	cset	x20, lt
               	cmp	x20, #0x0
               	b.ne	0x400934 <.text+0x634>
               	b	0x4008e4 <.text+0x5e4>
               	mov	x20, #0x0               // =0
               	cbnz	x20, 0x4008a0 <.text+0x5a0>
               	...
               	cset	x21, eq
               	cmp	x21, #0x0
               	b.ne	0x4009e0 <.text+0x6e0>
               	b	0x400990 <.text+0x690>
               	mov	x21, #0x0               // =0
               	cbnz	x21, 0x400938 <.text+0x638>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x158
               	mov	x0, x19
               	ldrsw	x21, [x0]
               	cmp	x21, #0x0
               	b.ne	0x400a30 <.text+0x730>
               	b	0x4009e4 <.text+0x6e4>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x158
               	mov	x26, x19
               	mov	x20, #0x66              // =102
