...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400b92 <.text+0x892>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400b89 <.text+0x889>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400b8d <.text+0x88d>
               	andb	%ch, 0x74(%rax)
               	je	0x400b9d <.text+0x89d>
               	jae	0x400b69 <.text+0x869>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400c52 <exit+0x29>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400c49 <exit+0x20>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400c4d <exit+0x24>
               	andb	%ch, 0x74(%rax)
               	je	0x400c5d <exit+0x34>
               	jae	0x400c29 <exit>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
...
<dlsym>:
               	jmpq	*0xf4c3(%rip)           # 0x4100e0

<fprintf>:
               	jmpq	*0xf4c5(%rip)           # 0x4100e8

<printf>:
               	jmpq	*0xf4c7(%rip)           # 0x4100f0

<exit>:
               	jmpq	*0xf4c9(%rip)           # 0x4100f8
