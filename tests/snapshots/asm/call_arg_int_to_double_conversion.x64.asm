...
<.text>:
               	...
               	movq	%r14, %rsi
               	xorl	%eax, %eax
               	callq	0x400a17 <dlsym>
               	movq	%rax, %rsi
               	cmpq	$0x0, %rsi
               	je	0x40041c <.text+0x11c>
               	leaq	0xfd14(%rip), %r14      # 0x410118
               	movq	%rbx, %r12
               	shlq	$0x3, %r12
               	movq	%r14, %rdi
               	addq	%r12, %rdi
               	...
               	popq	%rbp
               	retq
               	leaq	0xf8c4(%rip), %r12      # 0x410168
               	movq	%r12, %rdi
               	movb	$0x0, %al
               	callq	0x400a23 <printf>
               	movslq	%eax, %rax
               	movq	%rax, %r15
               	xorq	%r15, %r15
               	movq	%r15, %rcx
