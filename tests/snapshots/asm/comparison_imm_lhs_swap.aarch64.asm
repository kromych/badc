...
<.text>:
               	...
               	sxtw	x14, w15
               	cmp	x14, #0xa
               	b.gt	0x4004b0 <.text+0x1f0>
               	ldursw	x13, [x29, #-0x18]
               	add	x13, x13, #0x1
               	sxtw	x13, w13
               	stur	w13, [x29, #-0x18]
               	b	0x4004b0 <.text+0x1f0>
               	mov	x17, #0xffff            // =65535
               	movk	x17, #0xffff, lsl #16
               	and	x13, x15, x17
               	cmp	x13, #0x0
               	b.ls	0x4004d8 <.text+0x218>
               	ldursw	x14, [x29, #-0x18]
               	add	x14, x14, #0x1
               	sxtw	x14, w14
               	stur	w14, [x29, #-0x18]
