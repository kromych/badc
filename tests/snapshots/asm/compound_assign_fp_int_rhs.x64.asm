...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40073e <.text+0x4be>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400735 <.text+0x4b5>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400739 <.text+0x4b9>
               	andb	%ch, 0x74(%rax)
               	je	0x400749 <.text+0x4c9>
               	jae	0x400715 <.text+0x495>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400802 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4007f9 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4007fd <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x40080d <exit+0x40>
               	jae	0x4007d9 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf913(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xf915(%rip)           # 0x4100e8
