...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400802 <.text+0x582>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4007f9 <.text+0x579>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4007fd <.text+0x57d>
               	andb	%ch, 0x74(%rax)
               	je	0x40080d <.text+0x58d>
               	jae	0x4007d9 <.text+0x559>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4008c2 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4008b9 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4008bd <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x4008cd <exit+0x40>
               	jae	0x400899 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
