...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406cd0 <exit+0x6500>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8d60
               	tbz	w21, #0x6, 0x3fed24
               	<unknown>
               	cbnz	w16, 0x46eccc
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406d94 <exit+0x65c4>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8e24
               	tbz	w21, #0x6, 0x3fede8
               	<unknown>
               	cbnz	w16, 0x46ed90
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
