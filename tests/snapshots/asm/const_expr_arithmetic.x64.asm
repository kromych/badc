...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40082e <.text+0x56e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400825 <.text+0x565>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400829 <.text+0x569>
               	andb	%ch, 0x74(%rax)
               	je	0x400839 <.text+0x579>
               	jae	0x400805 <.text+0x545>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4008f2 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4008e9 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4008ed <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x4008fd <exit+0x3a>
               	jae	0x4008c9 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf823(%rip)           # 0x4100e0

<printf>:
               	jmpq	*0xf825(%rip)           # 0x4100e8

<exit>:
               	jmpq	*0xf827(%rip)           # 0x4100f0
