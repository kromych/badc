...
<.text>:
               	...
               	popq	%rdx
               	cmpq	$0x6, %rax
               	je	0x4004e4 <.text+0x224>
               	leaq	0xfed5(%rip), %r14      # 0x410383
               	movl	$0x18, %eax
               	movl	$0x4, %ebx
               	movq	%rbx, %r11
               	pushq	%rax
               	...
               	popq	%rdx
               	cmpq	$0x10, %rax
               	je	0x400544 <.text+0x284>
               	leaq	0xfe89(%rip), %r15      # 0x410396
               	movl	$0x40, %eax
               	movl	$0x4, %r14d
               	movq	%r14, %r11
               	pushq	%rax
               	...
               	popq	%rdx
               	cmpq	$0x10, %rax
               	je	0x4005a0 <.text+0x2e0>
               	leaq	0xfe3c(%rip), %rbx      # 0x4103a9
               	movl	$0x40, %eax
               	movl	$0x4, %r12d
               	movq	%r12, %r11
               	pushq	%rax
               	...
               	popq	%rax
               	cmpq	$0x6, %r12
               	je	0x40060c <.text+0x34c>
               	leaq	0xfdeb(%rip), %r14      # 0x4103bc
               	movl	$0x18, %r12d
               	movl	$0x4, %r15d
               	movq	%r15, %r11
               	pushq	%rax
               	...
               	popq	%rdx
               	cmpq	$0x8, %rax
               	je	0x40066c <.text+0x3ac>
               	leaq	0xfd9a(%rip), %r15      # 0x4103cf
               	movl	$0x20, %eax
               	movl	$0x4, %r14d
               	movq	%r14, %r11
               	pushq	%rax
               	...
               	popq	%rdx
               	cmpq	$0x6, %rax
               	je	0x4006cc <.text+0x40c>
               	leaq	0xfd51(%rip), %rbx      # 0x4103e6
               	movl	$0x18, %eax
               	movl	$0x4, %r15d
               	movq	%r15, %r11
               	pushq	%rax
