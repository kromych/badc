...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x407058 <exit+0x6504>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f90e8
               	tbz	w21, #0x6, 0x3ff0ac
               	<unknown>
               	cbnz	w16, 0x46f054
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x400660 <.text+0x3e0>
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x407124 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f91b4
               	tbz	w21, #0x6, 0x3ff178
               	<unknown>
               	cbnz	w16, 0x46f120
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40072c <.text+0x4ac>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
