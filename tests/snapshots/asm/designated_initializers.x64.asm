...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400b82 <.text+0x902>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400b79 <.text+0x8f9>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400b7d <.text+0x8fd>
               	andb	%ch, 0x74(%rax)
               	je	0x400b8d <.text+0x90d>
               	jae	0x400b59 <.text+0x8d9>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400c42 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400c39 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400c3d <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x400c4d <exit+0x40>
               	jae	0x400c19 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf4d3(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xf4d5(%rip)           # 0x4100e8
