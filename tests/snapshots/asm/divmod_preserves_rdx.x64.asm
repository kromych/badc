...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40060e <.text+0x34e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400605 <.text+0x345>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400609 <.text+0x349>
               	andb	%ch, 0x74(%rax)
               	je	0x400619 <.text+0x359>
               	jae	0x4005e5 <.text+0x325>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4006d2 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4006c9 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4006cd <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x4006dd <exit+0x3a>
               	jae	0x4006a9 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xfa43(%rip)           # 0x4100e0

<printf>:
               	jmpq	*0xfa45(%rip)           # 0x4100e8

<exit>:
               	jmpq	*0xfa47(%rip)           # 0x4100f0
