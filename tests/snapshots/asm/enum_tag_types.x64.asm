...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40055a <.text+0x33a>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400551 <.text+0x331>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400555 <.text+0x335>
               	andb	%ch, 0x74(%rax)
               	je	0x400565 <.text+0x345>
               	jae	0x400531 <.text+0x311>
               	<unknown>
               	<unknown>
