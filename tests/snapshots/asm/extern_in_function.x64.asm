...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40045e <.text+0x23e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400455 <.text+0x235>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400459 <.text+0x239>
               	andb	%ch, 0x74(%rax)
               	je	0x400469 <.text+0x249>
               	jae	0x400435 <.text+0x215>
               	<unknown>
               	<unknown>
