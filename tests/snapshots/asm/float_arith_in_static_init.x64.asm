...
<.text>:
               	...
               	orq	%r11, %r9
               	cmpq	$0x0, %r9
               	je	0x400489 <.text+0x209>
               	movl	$0x2, %eax
               	addq	$0x10, %rsp
               	popq	%rbp
               	retq
               	leaq	0xfcb8(%rip), %r9       # 0x410148
               	addq	$0x8, %r9
               	movss	(%r9,%riz), %xmm6
               	cvtss2sd	%xmm6, %xmm6
               	...
               	movq	%r9, -0x8(%rbp)
               	cmpq	$0x0, %r9
               	jne	0x400566 <.text+0x2e6>
               	leaq	0xfc1f(%rip), %rax      # 0x410158
               	movq	(%rax), %r9
