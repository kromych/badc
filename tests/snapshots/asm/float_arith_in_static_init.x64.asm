...
<.text>:
               	...
               	orq	%r11, %r9
               	cmpq	$0x0, %r9
               	je	0x400432 <.text+0x1b2>
               	movl	$0x1, %eax
               	addq	$0x10, %rsp
               	popq	%rbp
               	retq
               	leaq	0xfd0f(%rip), %r9       # 0x410148
               	movq	%r9, %rax
               	addq	$0x4, %rax
               	movss	(%rax,%riz), %xmm7
               	cvtss2sd	%xmm7, %xmm7
               	...
               	orq	%r11, %rax
               	cmpq	$0x0, %rax
               	je	0x4004a9 <.text+0x229>
               	movl	$0x2, %r9d
               	movq	%r9, %rax
               	addq	$0x10, %rsp
               	popq	%rbp
               	retq
               	leaq	0xfc98(%rip), %rax      # 0x410148
               	movq	%rax, %r9
               	addq	$0x8, %r9
               	movss	(%r9,%riz), %xmm6
               	cvtss2sd	%xmm6, %xmm6
               	...
               	movq	%r8, -0x8(%rbp)
               	cmpq	$0x0, %r8
               	jne	0x400589 <.text+0x309>
               	leaq	0xfbfc(%rip), %rax      # 0x410158
               	movq	(%rax), %r8
               	...
               	movzbq	%r9b, %r9
               	movq	%r9, -0x8(%rbp)
               	jmp	0x400589 <.text+0x309>
               	movq	-0x8(%rbp), %r9
               	cmpq	$0x0, %r9
               	je	0x4005a8 <.text+0x328>
               	movl	$0x4, %eax
               	addq	$0x10, %rsp
               	popq	%rbp
               	retq
               	leaq	0xfba9(%rip), %r9       # 0x410158
               	movq	%r9, %rax
               	addq	$0x8, %rax
               	movq	(%rax), %r9
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4006e6 <.text+0x466>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4006dd <.text+0x45d>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4006e1 <.text+0x461>
               	andb	%ch, 0x74(%rax)
               	je	0x4006f1 <.text+0x471>
               	jae	0x4006bd <.text+0x43d>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4007a2 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400799 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40079d <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x4007ad <exit+0x40>
               	jae	0x400779 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf973(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xf975(%rip)           # 0x4100e8
