...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4008aa <.text+0x68a>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4008a1 <.text+0x681>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4008a5 <.text+0x685>
               	andb	%ch, 0x74(%rax)
               	je	0x4008b5 <.text+0x695>
               	jae	0x400881 <.text+0x661>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400962 <exit+0x3b>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400959 <exit+0x32>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40095d <exit+0x36>
               	andb	%ch, 0x74(%rax)
               	je	0x40096d <exit+0x46>
               	jae	0x400939 <exit+0x12>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
