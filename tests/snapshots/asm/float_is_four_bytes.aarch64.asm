...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x407254 <exit+0x64f8>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f92e4
               	tbz	w21, #0x6, 0x3ff2a8
               	<unknown>
               	cbnz	w16, 0x46f250
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x40085c <.text+0x55c>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x407314 <exit+0x65b8>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f93a4
               	tbz	w21, #0x6, 0x3ff368
               	<unknown>
               	cbnz	w16, 0x46f310
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40091c <.text+0x61c>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
