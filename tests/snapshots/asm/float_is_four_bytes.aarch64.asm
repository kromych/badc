...
<.text>:
               	...
               	mov	x0, #0x2                // =2
               	stur	w0, [x29, #-0x8]
               	b	0x4005bc <.text+0x2bc>
               	mov	x0, #0x0                // =0
               	sub	x21, x29, #0x10
               	fmov	d0, x0
               	fcvt	s0, d0
               	str	s0, [x21]
               	cbz	x0, 0x400600 <.text+0x300>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x199
               	mov	x20, x19
               	mov	x21, #0x4               // =4
               	...
               	ldr	s8, [x20]
               	fcvt	d8, s8
               	mov	x20, #0x4012000000000000 // =4616752568008179712
               	fmov	d1, x20
               	fcmp	d8, d1
               	cset	x0, ne
               	cbz	x0, 0x4008c8 <.text+0x5c8>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x240
               	mov	x21, x19
               	adrp	x19, 0x410000
               	...
               	mov	x2, x23
               	mov	x1, x20
               	bl	0x40048c <.text+0x18c>
               	mov	x23, #0x401a000000000000 // =4619004367821864960
               	fmov	d0, x0
               	fmov	d1, x23
               	fcmp	d0, d1
               	cset	x20, ne
               	cbz	x20, 0x400a38 <.text+0x738>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x2ac
               	mov	x22, x19
