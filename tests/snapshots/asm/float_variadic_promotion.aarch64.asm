...
<main>:
               	...
               	b.pl	<addr>
               	fneg	d0, d0
               	mov	x23, #0xa9fc            // =43516
               	movk	x23, #0xd2f1, lsl #16
               	movk	x23, #0x624d, lsl #32
               	movk	x23, #0x3f50, lsl #48
               	fmov	d17, x23
               	fcmp	d0, d17
               	cset	x0, mi
               	sxtw	x0, w0
               	...
               	b.pl	<addr>
               	fneg	d0, d0
               	mov	x20, #0xa9fc            // =43516
               	movk	x20, #0xd2f1, lsl #16
               	movk	x20, #0x624d, lsl #32
               	movk	x20, #0x3f50, lsl #48
               	fmov	d17, x20
               	fcmp	d0, d17
               	cset	x0, mi
               	sxtw	x0, w0
