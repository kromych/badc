...
<main>:
               	...
               	mov	x5, #0x4024000000000000 // =4621819117588971520
               	fmov	d17, x5
               	fcmp	d0, d17
               	b.eq	<addr>
               	mov	x0, #0x1                // =1
               	...
               	mov	x4, #0x3fc0000000000000 // =4593671619917905920
               	fmov	d16, x3
               	fmov	d17, x1
               	fmov	d18, x4
               	...
               	mov	x0, #0x7                // =7
               	ret
               	mov	x4, #0x3f000000         // =1056964608
               	mov	x3, #0x3e800000         // =1048576000
               	mov	x7, #0x3e000000         // =1040187392
               	fmov	s16, w4
               	fmov	s17, w3
               	fmov	s18, w7
