...
<.text>:
               	...
               	popq	%rbp
               	retq
               	leaq	-0x78(%rip), %r12       # 0x400237 <.text+0x17>
               	movq	%r12, -0x30(%rbp)
               	jmp	0x4002fe <.text+0xde>
               	leaq	-0x88(%rip), %rbx       # 0x400237 <.text+0x17>
               	leaq	-0x8(%rbp), %r12
               	movslq	(%r12), %r14
               	movl	$0x1, %r15d
               	movq	%rbx, %r11
               	...
               	leaq	-0x115(%rip), %r14      # 0x400237 <.text+0x17>
               	movq	%r14, -0x48(%rbp)
               	leaq	-0x8(%rbp), %r12
               	movslq	(%r12), %r15
               	leaq	-0x48(%rbp), %rbx
