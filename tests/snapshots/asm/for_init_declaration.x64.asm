...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4009ca <.text+0x70a>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4009c1 <.text+0x701>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4009c5 <.text+0x705>
               	andb	%ch, 0x74(%rax)
               	je	0x4009d5 <.text+0x715>
               	jae	0x4009a1 <.text+0x6e1>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400a82 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400a79 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400a7d <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x400a8d <exit+0x3a>
               	jae	0x400a59 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf693(%rip)           # 0x4100e0

<printf>:
               	jmpq	*0xf695(%rip)           # 0x4100e8

<exit>:
               	jmpq	*0xf697(%rip)           # 0x4100f0
