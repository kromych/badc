...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400646 <.text+0x3c6>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x40063d <.text+0x3bd>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400641 <.text+0x3c1>
               	andb	%ch, 0x74(%rax)
               	je	0x400651 <.text+0x3d1>
               	jae	0x40061d <.text+0x39d>
               	<unknown>
               	<unknown>
