...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406ec4 <exit+0x6510>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8f54
               	tbz	w21, #0x6, 0x3fef18
               	<unknown>
               	cbnz	w16, 0x46eec0
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x4004cc <.text+0x24c>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406f84 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9014
               	tbz	w21, #0x6, 0x3fefd8
               	<unknown>
               	cbnz	w16, 0x46ef80
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40058c <.text+0x30c>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
