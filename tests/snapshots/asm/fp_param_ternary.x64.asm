...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400b4a <.text+0x8ca>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400b41 <.text+0x8c1>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400b45 <.text+0x8c5>
               	andb	%ch, 0x74(%rax)
               	je	0x400b55 <.text+0x8d5>
               	jae	0x400b21 <.text+0x8a1>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400c02 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400bf9 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400bfd <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x400c0d <exit+0x40>
               	jae	0x400bd9 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf513(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xf515(%rip)           # 0x4100e8
