...
<.text>:
               	...
               	popq	%rbp
               	retq
               	leaq	0xfd11(%rip), %r15      # 0x4100fc
               	movq	%r12, %rdi
               	movq	%r15, %rsi
               	callq	0x400237 <.text+0x17>
               	cmpq	$0x0, %rax
               	jne	0x40042a <.text+0x20a>
               	movl	$0x16, %eax
               	movq	%rax, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
               	...
               	popq	%rbp
               	retq
               	leaq	0xfcd6(%rip), %r15      # 0x410107
               	movq	%r14, %rdi
               	movq	%r15, %rsi
               	callq	0x400237 <.text+0x17>
               	cmpq	$0x0, %rax
               	jne	0x400470 <.text+0x250>
               	movl	$0x17, %eax
               	movq	%rax, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
               	...
               	movq	%rbx, (%rsp)
               	movq	%r12, 0x8(%rsp)
               	leaq	0xfbe4(%rip), %rbx      # 0x410112
               	leaq	0xfbe8(%rip), %r12      # 0x41011d
               	movq	%rbx, %rdi
               	movq	%r12, %rsi
               	callq	0x400237 <.text+0x17>
               	cmpq	$0x0, %rax
               	...
               	popq	%rbp
               	retq
               	callq	0x400513 <.text+0x2f3>
               	movslq	%eax, %rbx
               	cmpq	$0x0, %rbx
               	je	0x400608 <.text+0x3e8>
               	movslq	%eax, %rbx
               	movq	%rbx, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
               	...
               	popq	%rbp
               	retq
               	leaq	0xfb19(%rip), %r12      # 0x410128
               	leaq	0xfb17(%rip), %r14      # 0x41012d
               	movq	%r12, %rdi
               	movq	%r14, %rsi
               	callq	0x400237 <.text+0x17>
               	cmpq	$0x0, %rax
               	jne	0x400650 <.text+0x430>
               	movl	$0x29, %eax
               	movq	%rax, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
