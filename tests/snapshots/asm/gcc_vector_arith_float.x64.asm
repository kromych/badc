...
<main>:
               	...
               	movsd	0x8(%rcx,%riz), %xmm2
               	addsd	%xmm2, %xmm1
               	leaq	0x100(%rsp), %rsi
               	movsd	%xmm0, (%rsi,%riz)
               	movsd	%xmm1, 0x8(%rsi,%riz)
               	leaq	-0x180(%rbp), %rdx
               	leaq	(%rdx), %rdi
               	leaq	(%rax), %r8
               	movsd	(%r8,%riz), %xmm0
               	...
               	leaq	0x180(%rsp), %rsi
               	movss	%xmm0, (%rsi,%riz)
               	movss	%xmm1, 0x4(%rsi,%riz)
               	movss	%xmm2, 0x8(%rsi,%riz)
               	movss	%xmm3, 0xc(%rsi,%riz)
               	leaq	0x190(%rsp), %rdx
               	pushq	%rax
               	movq	(%rcx), %rax
               	movq	%rax, (%rdx)
               	...
               	movss	0x4(%r8,%riz), %xmm2
               	addss	%xmm2, %xmm1
               	movss	0x8(%rsi,%riz), %xmm2
               	movss	0x8(%r8,%riz), %xmm3
               	addss	%xmm3, %xmm2
               	movss	0xc(%rsi,%riz), %xmm3
               	movss	0xc(%r8,%riz), %xmm4
               	addss	%xmm4, %xmm3
