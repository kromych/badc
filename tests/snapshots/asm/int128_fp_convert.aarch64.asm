...
<main>:
               	...
               	mov	x21, #0x47e0000000000000 // =5179139571476070400
               	mov	x22, #0x7f000000        // =2130706432
               	...
               	ldp	x20, x21, [sp], #0x90
               	ret
               	mov	x21, #0xa1cb            // =41419
               	movk	x21, #0xb645, lsl #16
               	movk	x21, #0xfdf3, lsl #32
               	movk	x21, #0x400f, lsl #48
               	mov	x2, #0x3                // =3
               	mov	x3, #0x43               // =67
               	fmov	d0, x21
               	mov	x0, x20
