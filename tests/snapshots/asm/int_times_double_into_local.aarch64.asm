...
<.text>:
               	...
               	fmov	d0, x23
               	fneg	d7, d0
               	mov	x23, #0x2d18            // =11544
               	movk	x23, #0x5444, lsl #16
               	movk	x23, #0x21fb, lsl #32
               	movk	x23, #0x4009, lsl #48
               	fmov	d1, x23
               	fmul	d7, d7, d1
               	fmov	d0, x0
               	fcmp	d0, d7
               	cset	x0, ne
               	cbz	x0, 0x400500 <.text+0x280>
               	mov	x23, #0x2               // =2
               	mov	x0, x23
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
