...
<.text>:
               	...
               	cset	x14, mi
               	stur	x14, [x29, #-0x50]
               	b	0x40069c <.text+0x3dc>
               	ldur	x14, [x29, #-0x50]
               	cbz	x14, 0x4006c0 <.text+0x400>
               	mov	x12, #0x5               // =5
               	mov	x0, x12
               	ldr	x20, [sp]
               	ldr	x19, [sp, #0x10]
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406da4 <exit+0x6504>
               	<unknown>
               	<unknown>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406e64 <exit+0x65c4>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8ef4
               	tbz	w21, #0x6, 0x3feeb8
               	<unknown>
               	cbnz	w16, 0x46ee60
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40046c <.text+0x1ac>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
