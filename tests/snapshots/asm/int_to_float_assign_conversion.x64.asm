...
<.text>:
               	...
               	andq	%r11, %r9
               	movq	%r9, -0x50(%rbp)
               	jmp	0x400711 <.text+0x451>
               	movq	-0x50(%rbp), %r9
               	cmpq	$0x0, %r9
               	je	0x40073b <.text+0x47b>
               	movl	$0x5, %r8d
               	movq	%r8, %rcx
               	movq	(%rsp), %rbx
               	movq	%rcx, %rax
               	...
               	popq	%rbp
               	retq
               	leaq	0xf993(%rip), %rbx      # 0x410150
               	movq	%rbx, %rdi
               	movb	$0x0, %al
               	callq	0x40092d <printf>
               	movslq	%eax, %rax
               	xorq	%rax, %rax
               	movq	%rax, %rcx
               	movq	(%rsp), %rbx
