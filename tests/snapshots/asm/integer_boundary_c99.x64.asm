...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40264e <.text+0x234e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x402645 <.text+0x2345>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x402649 <.text+0x2349>
               	andb	%ch, 0x74(%rax)
               	je	0x402659 <.text+0x2359>
               	jae	0x402625 <.text+0x2325>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x402712 <exit+0x29>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x402709 <exit+0x20>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40270d <exit+0x24>
               	andb	%ch, 0x74(%rax)
               	je	0x40271d <exit+0x34>
               	jae	0x4026e9 <exit>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
...
<dlsym>:
               	jmpq	*0xda03(%rip)           # 0x4100e0

<fprintf>:
               	jmpq	*0xda05(%rip)           # 0x4100e8

<printf>:
               	jmpq	*0xda07(%rip)           # 0x4100f0

<exit>:
               	jmpq	*0xda09(%rip)           # 0x4100f8
