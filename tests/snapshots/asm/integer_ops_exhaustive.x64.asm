...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4023e6 <.text+0x2126>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4023dd <.text+0x211d>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4023e1 <.text+0x2121>
               	andb	%ch, 0x74(%rax)
               	je	0x4023f1 <.text+0x2131>
               	jae	0x4023bd <.text+0x20fd>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4024a2 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x402499 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40249d <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x4024ad <exit+0x3a>
               	jae	0x402479 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xdc73(%rip)           # 0x4100e0

<printf>:
               	jmpq	*0xdc75(%rip)           # 0x4100e8

<exit>:
               	jmpq	*0xdc77(%rip)           # 0x4100f0
