...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x407108 <exit+0x6510>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9198
               	tbz	w21, #0x6, 0x3ff15c
               	<unknown>
               	cbnz	w16, 0x46f104
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x400710 <.text+0x4f0>
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x4071d4 <exit+0x65dc>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9264
               	tbz	w21, #0x6, 0x3ff228
               	<unknown>
               	cbnz	w16, 0x46f1d0
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x4007dc <.text+0x5bc>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
