...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400d8e <.text+0xb6e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400d85 <.text+0xb65>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400d89 <.text+0xb69>
               	andb	%ch, 0x74(%rax)
               	je	0x400d99 <.text+0xb79>
               	jae	0x400d65 <.text+0xb45>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400e52 <exit+0x3b>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400e49 <exit+0x32>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400e4d <exit+0x36>
               	andb	%ch, 0x74(%rax)
               	je	0x400e5d <exit+0x46>
               	jae	0x400e29 <exit+0x12>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
