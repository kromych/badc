...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400362 <.text+0x132>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400359 <.text+0x129>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40035d <.text+0x12d>
               	andb	%ch, 0x74(%rax)
               	je	0x40036d <.text+0x13d>
               	jae	0x400339 <.text+0x109>
               	<unknown>
               	<unknown>
