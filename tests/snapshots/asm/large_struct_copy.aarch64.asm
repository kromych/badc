...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x4072d8 <exit+0x64ec>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9368
               	tbz	w21, #0x6, 0x3ff32c
               	<unknown>
               	cbnz	w16, 0x46f2d4
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x4008e0 <.text+0x5e0>
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x4073a4 <exit+0x65b8>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9434
               	tbz	w21, #0x6, 0x3ff3f8
               	<unknown>
               	cbnz	w16, 0x46f3a0
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x4009ac <.text+0x6ac>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
