...
<.text>:
               	...
               	sub	x17, x29, #0x460
               	str	x22, [x17]
               	b	0x4009b8 <.text+0x6b8>
               	sub	x16, x29, #0x460
               	ldr	x22, [x16]
               	cbz	x22, 0x4009ec <.text+0x6ec>
               	mov	x21, #0x2               // =2
               	mov	x0, x21
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
               	...
               	sub	x17, x29, #0x428
               	str	w21, [x17]
               	b	0x400ae0 <.text+0x7e0>
               	sub	x16, x29, #0x428
               	ldrsw	x21, [x16]
               	cmp	x21, #0x28
               	b.ge	0x400b38 <.text+0x838>
               	...
               	sxtw	x20, w20
               	cmp	x21, x20
               	b.eq	0x400ba4 <.text+0x8a4>
               	b	0x400b74 <.text+0x874>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x158
               	mov	x23, x19
               	mov	x0, x23
