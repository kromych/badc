...
<.text>:
               	...
               	movq	0x200(%rsi), %r11
               	movq	%r11, 0x200(%rax)
               	movzbq	0x208(%rsi), %r11
               	movb	%r11b, 0x208(%rax)
               	movzbq	0x209(%rsi), %r11
               	movb	%r11b, 0x209(%rax)
               	movzbq	0x20a(%rsi), %r11
               	movb	%r11b, 0x20a(%rax)
               	movzbq	0x20b(%rsi), %r11
               	movb	%r11b, 0x20b(%rax)
               	popq	%r11
               	leaq	-0x420(%rbp), %rax
               	movslq	(%rax), %rax
               	...
               	retq
               	leaq	-0x420(%rbp), %rsi
               	addq	$0x1fc, %rsi            # imm = 0x1FC
               	movslq	(%rsi), %rsi
               	cmpq	$0x1f4, %rsi            # imm = 0x1F4
               	setne	%sil
               	movzbq	%sil, %rsi
               	movq	%rsi, -0x470(%rbp)
               	cmpq	$0x0, %rsi
               	...
               	jne	<addr>
               	leaq	-0x420(%rbp), %rsi
               	addq	$0x204, %rsi            # imm = 0x204
               	movslq	(%rsi), %rsi
               	cmpq	$0x2bc, %rsi            # imm = 0x2BC
               	setne	%sil
               	movzbq	%sil, %rsi
               	movq	%rsi, -0x468(%rbp)
               	jmp	<addr>
