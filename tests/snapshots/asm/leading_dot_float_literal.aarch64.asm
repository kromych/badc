...
<.text>:
               	...
               	fcmp	d0, d1
               	cset	x11, ne
               	cbz	x11, 0x400478 <.text+0x1f8>
               	mov	x15, #0x0               // =0
               	stur	w15, [x29, #-0x28]
               	b	0x400478 <.text+0x1f8>
               	sub	x16, x29, #0x20
               	ldr	s7, [x16]
               	fcvt	d7, s7
               	...
               	fcmp	d7, d1
               	cset	x15, ne
               	cbz	x15, 0x4004a4 <.text+0x224>
               	mov	x11, #0x0               // =0
               	stur	w11, [x29, #-0x28]
               	b	0x4004a4 <.text+0x224>
               	ldursw	x11, [x29, #-0x28]
               	cbz	x11, 0x4004b8 <.text+0x238>
               	mov	x15, #0x7               // =7
               	stur	x15, [x29, #-0x30]
