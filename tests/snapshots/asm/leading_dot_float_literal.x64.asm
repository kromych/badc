...
<.text>:
               	...
               	orq	%r11, %rsi
               	cmpq	$0x0, %rsi
               	je	0x4004fe <.text+0x27e>
               	xorq	%r11, %r11
               	movl	%r11d, -0x28(%rbp)
               	jmp	0x4004fe <.text+0x27e>
               	...
               	xorq	%rsi, %rsi
               	movl	%esi, -0x28(%rbp)
               	jmp	0x40054a <.text+0x2ca>
               	movslq	-0x28(%rbp), %rsi
               	cmpq	$0x0, %rsi
               	je	0x40056a <.text+0x2ea>
               	movl	$0x7, %r11d
               	movq	%r11, -0x30(%rbp)
               	jmp	0x400576 <.text+0x2f6>
               	xorq	%r11, %r11
               	movq	%r11, -0x30(%rbp)
               	jmp	0x400576 <.text+0x2f6>
               	movq	-0x30(%rbp), %rax
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400642 <.text+0x3c2>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400639 <.text+0x3b9>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40063d <.text+0x3bd>
               	andb	%ch, 0x74(%rax)
               	je	0x40064d <.text+0x3cd>
               	jae	0x400619 <.text+0x399>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400702 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4006f9 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4006fd <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x40070d <exit+0x40>
               	jae	0x4006d9 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xfa13(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xfa15(%rip)           # 0x4100e8
