...
libc_math_libm.x64:	file format elf64-x86-64
...
<main>:
               	...
               	movq	%rbx, (%rsp)
               	movq	%r12, 0x8(%rsp)
               	movabsq	$0x403b000000000000, %rdi # imm = 0x403B000000000000
               	movq	%rdi, %xmm0
               	xorl	%eax, %eax
               	callq	<addr>
               	...
               	movq	%r10, %xmm15
               	xorpd	%xmm15, %xmm0
               	movabsq	$0x3e112e0be826d695, %r12 # imm = 0x3E112E0BE826D695
               	movq	%r12, %xmm15
               	ucomisd	%xmm15, %xmm0
               	setb	%al
               	movzbq	%al, %rax
               	...
               	popq	%rbp
               	retq
               	movl	$0x41d80000, %edi       # imm = 0x41D80000
               	movq	%rdi, %xmm0
               	xorl	%eax, %eax
               	callq	<addr>
               	cvtss2sd	%xmm0, %xmm0
