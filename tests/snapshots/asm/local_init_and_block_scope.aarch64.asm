...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406d28 <exit+0x6510>
               	<unknown>
               	<unknown>
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x400330 <.text+0x110>
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406df4 <exit+0x65dc>
               	<unknown>
               	<unknown>
               	<unknown>
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x4003fc <.text+0x1dc>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
