...
<.text>:
               	...
               	ldr	s7, [x16]
               	fcvt	d7, s7
               	mov	x14, #0x1c4000000000    // =31061203484672
               	movk	x14, #0x40c8, lsl #48
               	fmov	d1, x14
               	fcmp	d7, d1
               	cset	x20, mi
               	stur	x20, [x29, #-0x80]
               	cbnz	x20, 0x4005bc <.text+0x2fc>
               	sub	x16, x29, #0x20
               	ldr	s7, [x16]
               	fcvt	d7, s7
               	mov	x20, #0x1cc000000000    // =31610959298560
               	...
               	stur	x16, [x29, #-0x30]
               	ldur	x14, [x29, #-0x30]
               	mov	x21, #0x401e000000000000 // =4620130267728707584
               	fmov	d0, x21
               	fneg	d9, d0
               	fmov	d0, x14
               	fcmp	d0, d9
               	...
               	cset	x21, gt
               	stur	x21, [x29, #-0x88]
               	b	0x40068c <.text+0x3cc>
               	ldur	x21, [x29, #-0x88]
               	cbz	x21, 0x4006e8 <.text+0x428>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x182
               	mov	x20, x19
               	ldur	x22, [x29, #-0x30]
               	...
               	cset	x22, mi
               	stur	x22, [x29, #-0x90]
               	cbnz	x22, 0x400764 <.text+0x4a4>
               	sub	x16, x29, #0x40
               	ldr	s8, [x16]
               	fcvt	d8, s8
               	mov	x22, #0xb0000000        // =2952790016
               	movk	x22, #0x4cc, lsl #32
               	movk	x22, #0x41f0, lsl #48
               	fmov	d1, x22
               	fcmp	d8, d1
               	cset	x15, gt
               	stur	x15, [x29, #-0x90]
               	b	0x400764 <.text+0x4a4>
               	ldur	x15, [x29, #-0x90]
               	cbz	x15, 0x4007cc <.text+0x50c>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x19b
               	mov	x21, x19
               	sub	x16, x29, #0x40
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406f80 <exit+0x6500>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9010
               	tbz	w21, #0x6, 0x3fefd4
               	<unknown>
               	cbnz	w16, 0x46ef7c
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x400588 <.text+0x2c8>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x407044 <exit+0x65c4>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f90d4
               	tbz	w21, #0x6, 0x3ff098
               	<unknown>
               	cbnz	w16, 0x46f040
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40064c <.text+0x38c>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
