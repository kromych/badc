...
<.text>:
               	...
               	cset	x21, gt
               	stur	x21, [x29, #-0x88]
               	b	0x400674 <.text+0x3b4>
               	ldur	x21, [x29, #-0x88]
               	cbz	x21, 0x4006c8 <.text+0x408>
               	adrp	x19, 0x410000
               	add	x19, x19, #0x182
               	mov	x20, x19
               	ldur	x22, [x29, #-0x30]
