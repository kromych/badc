...
<.text>:
               	...
               	movzbq	%r9b, %r9
               	movq	%r9, -0x78(%rbp)
               	jmp	0x4004ef <.text+0x22f>
               	movq	-0x78(%rbp), %r9
               	cmpq	$0x0, %r9
               	je	0x400558 <.text+0x298>
               	leaq	0xfc4d(%rip), %rbx      # 0x410154
               	...
               	movzbq	%al, %rax
               	movq	%rax, -0x80(%rbp)
               	jmp	0x4005ef <.text+0x32f>
               	movq	-0x80(%rbp), %rax
               	cmpq	$0x0, %rax
               	je	0x400658 <.text+0x398>
               	leaq	0xfb63(%rip), %r12      # 0x41016a
               	...
               	movzbq	%r12b, %r12
               	movq	%r12, -0x88(%rbp)
               	jmp	0x400710 <.text+0x450>
               	movq	-0x88(%rbp), %r12
               	cmpq	$0x0, %r12
               	je	0x400763 <.text+0x4a3>
               	leaq	0xfa57(%rip), %rbx      # 0x410182
               	movq	-0x30(%rbp), %r14
               	movq	%r14, %xmm0
               	movq	%rbx, %rdi
               	movb	$0x1, %al
               	...
               	movzbq	%al, %rax
               	movq	%rax, -0x90(%rbp)
               	jmp	0x400806 <.text+0x546>
               	movq	-0x90(%rbp), %rax
               	cmpq	$0x0, %rax
               	je	0x400872 <.text+0x5b2>
               	leaq	0xf97a(%rip), %r12      # 0x41019b
               	...
               	movslq	%eax, %r12
               	cmpq	$0x3, %r12
               	je	0x4008f2 <.text+0x632>
               	leaq	0xf8f6(%rip), %r14      # 0x4101b3
               	movslq	%eax, %r12
               	movq	%r14, %rdi
               	movq	%r12, %rsi
               	movb	$0x0, %al
               	...
               	movslq	%eax, %r12
               	cmpq	$-0x2, %r12
               	je	0x400978 <.text+0x6b8>
               	leaq	0xf887(%rip), %rbx      # 0x4101ca
               	movslq	%eax, %r12
               	movq	%rbx, %rdi
               	movq	%r12, %rsi
               	movb	$0x0, %al
