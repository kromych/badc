...
<.text>:
               	...
               	cvtss2sd	%xmm7, %xmm7
               	movabsq	$0x40c81c4000000000, %r11 # imm = 0x40C81C4000000000
               	movq	%r11, %xmm15
               	ucomisd	%xmm15, %xmm7
               	setb	%al
               	movzbq	%al, %rax
               	...
               	jne	<addr>
               	movq	-0x30(%rbp), %rax
               	movabsq	$0x401a000000000000, %r11 # imm = 0x401A000000000000
               	movq	%r11, %xmm7
               	...
               	cvtss2sd	%xmm6, %xmm6
               	movabsq	$0x41eff68690000000, %rdi # imm = 0x41EFF68690000000
               	movq	%rdi, %xmm15
               	ucomisd	%xmm15, %xmm6
               	setb	%al
               	movzbq	%al, %rax
               	...
               	popq	%rbp
               	retq
               	movabsq	$0x4007333333333333, %r8 # imm = 0x4007333333333333
               	movq	%r8, %xmm6
               	movabsq	$-0x8000000000000000, %r11 # imm = 0x8000000000000000
               	movq	%r11, %xmm15
               	xorpd	%xmm15, %xmm6
