...
<.text>:
               	...
               	movq	-0x78(%rbp), %r9
               	cmpq	$0x0, %r9
               	je	0x400541 <.text+0x281>
               	leaq	0xfc64(%rip), %rbx      # 0x410154
               	...
               	movzbq	%bl, %rbx
               	movq	%rbx, -0x80(%rbp)
               	jmp	0x4005d8 <.text+0x318>
               	movq	-0x80(%rbp), %rbx
               	cmpq	$0x0, %rbx
               	je	0x400641 <.text+0x381>
               	leaq	0xfb7a(%rip), %r12      # 0x41016a
               	...
               	movzbq	%al, %rax
               	movq	%rax, -0x88(%rbp)
               	jmp	0x4006f9 <.text+0x439>
               	movq	-0x88(%rbp), %rax
               	cmpq	$0x0, %rax
               	je	0x40074c <.text+0x48c>
               	leaq	0xfa6e(%rip), %rbx      # 0x410182
               	movq	-0x30(%rbp), %r12
               	movq	%r12, %xmm0
               	movq	%rbx, %rdi
               	movb	$0x1, %al
               	...
               	movzbq	%r12b, %r12
               	movq	%r12, -0x90(%rbp)
               	jmp	0x4007f0 <.text+0x530>
               	movq	-0x90(%rbp), %r12
               	cmpq	$0x0, %r12
               	je	0x40085c <.text+0x59c>
               	leaq	0xf990(%rip), %r14      # 0x41019b
               	...
               	movslq	%eax, %rbx
               	cmpq	$-0x2, %rbx
               	je	0x400962 <.text+0x6a2>
               	leaq	0xf89d(%rip), %r14      # 0x4101ca
               	movslq	%eax, %r12
               	movq	%r14, %rdi
               	movq	%r12, %rsi
               	movb	$0x0, %al
