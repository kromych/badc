...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4006f6 <.text+0x4d6>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4006ed <.text+0x4cd>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4006f1 <.text+0x4d1>
               	andb	%ch, 0x74(%rax)
               	je	0x400701 <.text+0x4e1>
               	jae	0x4006cd <.text+0x4ad>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4007b2 <exit+0x3b>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4007a9 <exit+0x32>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4007ad <exit+0x36>
               	andb	%ch, 0x74(%rax)
               	je	0x4007bd <exit+0x46>
               	jae	0x400789 <exit+0x12>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
