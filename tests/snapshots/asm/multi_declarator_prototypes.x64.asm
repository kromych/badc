...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4003f6 <.text+0x1d6>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4003ed <.text+0x1cd>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4003f1 <.text+0x1d1>
               	andb	%ch, 0x74(%rax)
               	je	0x400401 <.text+0x1e1>
               	jae	0x4003cd <.text+0x1ad>
               	<unknown>
               	<unknown>
