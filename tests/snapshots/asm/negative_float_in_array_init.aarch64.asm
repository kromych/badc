...
<.text>:
               	...
               	stur	x16, [x29, #-0x8]
               	ldur	x12, [x29, #-0x8]
               	mov	x14, #0x94000000        // =2483027968
               	movk	x14, #0x449a, lsl #32
               	movk	x14, #0x421e, lsl #48
               	fmov	d0, x14
               	fneg	d7, d0
               	...
               	cset	x14, mi
               	stur	x14, [x29, #-0x10]
               	b	0x400558 <.text+0x2d8>
               	ldur	x14, [x29, #-0x10]
               	cbz	x14, 0x400574 <.text+0x2f4>
               	mov	x0, #0x4                // =4
               	ldr	x19, [sp]
               	add	sp, sp, #0x20
               	ldp	x29, x30, [sp], #0x10
