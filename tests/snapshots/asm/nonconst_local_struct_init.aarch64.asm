...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x407304 <exit+0x6504>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9394
               	tbz	w21, #0x6, 0x3ff358
               	<unknown>
               	cbnz	w16, 0x46f300
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x40090c <.text+0x64c>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x4073c4 <exit+0x65c4>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9454
               	tbz	w21, #0x6, 0x3ff418
               	<unknown>
               	cbnz	w16, 0x46f3c0
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x4009cc <.text+0x70c>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
