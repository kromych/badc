...
<.text>:
               	...
               	cset	x21, gt
               	stur	x21, [x29, #-0x38]
               	b	0x400588 <.text+0x208>
               	ldur	x21, [x29, #-0x38]
               	cbz	x21, 0x4005bc <.text+0x23c>
               	mov	x24, #0x1               // =1
               	mov	x0, x24
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
               	...
               	cset	x22, gt
               	stur	x22, [x29, #-0x40]
               	b	0x40060c <.text+0x28c>
               	ldur	x22, [x29, #-0x40]
               	cbz	x22, 0x400640 <.text+0x2c0>
               	mov	x21, #0x1               // =1
               	mov	x0, x21
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
               	...
               	cset	x0, gt
               	stur	x0, [x29, #-0x48]
               	b	0x4006d4 <.text+0x354>
               	ldur	x0, [x29, #-0x48]
               	cbz	x0, 0x400708 <.text+0x388>
               	mov	x20, #0x1               // =1
               	mov	x0, x20
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
