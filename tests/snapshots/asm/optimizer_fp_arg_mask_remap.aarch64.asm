...
<.text>:
               	...
               	cset	x10, gt
               	stur	x10, [x29, #-0x38]
               	b	0x400584 <.text+0x204>
               	ldur	x10, [x29, #-0x38]
               	cbz	x10, 0x4005b8 <.text+0x238>
               	mov	x24, #0x1               // =1
               	mov	x0, x24
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
               	...
               	cset	x24, gt
               	stur	x24, [x29, #-0x40]
               	b	0x400608 <.text+0x288>
               	ldur	x24, [x29, #-0x40]
               	cbz	x24, 0x40063c <.text+0x2bc>
               	mov	x10, #0x1               // =1
               	mov	x0, x10
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
               	...
               	cset	x24, gt
               	stur	x24, [x29, #-0x48]
               	b	0x4006d0 <.text+0x350>
               	ldur	x24, [x29, #-0x48]
               	cbz	x24, 0x400704 <.text+0x384>
               	mov	x10, #0x1               // =1
               	mov	x0, x10
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
