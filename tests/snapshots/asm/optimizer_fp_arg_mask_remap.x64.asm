...
<.text>:
               	...
               	movq	(%r9), %r8
               	cmpq	$0x0, %r8
               	je	0x400405 <.text+0x85>
               	leaq	0xfd4d(%rip), %r9       # 0x410128
               	movq	%rbx, %r8
               	shlq	$0x3, %r8
               	addq	%r8, %r9
               	movq	(%r9), %r8
               	...
               	leaq	-0x18(%rbp), %r9
               	xorq	%r12, %r12
               	leaq	0xfd2d(%rip), %rdi      # 0x410140
               	movq	%rdi, (%r9)
               	leaq	-0x18(%rbp), %rsi
               	addq	$0x8, %rsi
               	leaq	0xfd1e(%rip), %rdi      # 0x410146
               	movq	%rdi, (%rsi)
               	leaq	-0x18(%rbp), %r9
               	addq	$0x10, %r9
               	leaq	0xfd10(%rip), %rdi      # 0x41014d
               	movq	%rdi, (%r9)
               	leaq	-0x18(%rbp), %rsi
               	movq	%rbx, %rdi
               	shlq	$0x3, %rdi
               	...
               	movq	%r14, %rsi
               	xorl	%eax, %eax
               	callq	0x4008d7 <dlsym>
               	cmpq	$0x0, %rax
               	je	0x400487 <.text+0x107>
               	leaq	0xfcb6(%rip), %r14      # 0x410128
               	movq	%rbx, %r12
               	shlq	$0x3, %r12
               	addq	%r12, %r14
               	movq	(%rax), %r12
               	movq	%r12, (%r14)
               	jmp	0x400487 <.text+0x107>
               	leaq	0xfc9a(%rip), %r12      # 0x410128
               	shlq	$0x3, %rbx
               	addq	%rbx, %r12
               	movq	(%r12), %rbx
               	movq	%rbx, %rcx
               	...
               	movzbq	%r12b, %r12
               	movq	%r12, -0x38(%rbp)
               	jmp	0x400596 <.text+0x216>
               	movq	-0x38(%rbp), %r12
               	cmpq	$0x0, %r12
               	je	0x4005cf <.text+0x24f>
               	movl	$0x1, %r15d
               	movq	%r15, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
               	...
               	movzbq	%r14b, %r14
               	movq	%r14, -0x40(%rbp)
               	jmp	0x400636 <.text+0x2b6>
               	movq	-0x40(%rbp), %r14
               	cmpq	$0x0, %r14
               	je	0x40066f <.text+0x2ef>
               	movl	$0x1, %r12d
               	movq	%r12, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
               	...
               	movzbq	%al, %rax
               	movq	%rax, -0x48(%rbp)
               	jmp	0x400737 <.text+0x3b7>
               	movq	-0x48(%rbp), %rax
               	cmpq	$0x0, %rax
               	je	0x40076f <.text+0x3ef>
               	movl	$0x1, %ebx
               	movq	%rbx, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
