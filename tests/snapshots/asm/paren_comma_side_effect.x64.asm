...
<.text>:
               	...
               	movq	%rax, %r12
               	leaq	0xfcf0(%rip), %rbx      # 0x410158
               	movslq	%r14d, %r14
               	movq	%r12, %rdi
               	movq	%r14, %rdx
               	movq	%rbx, %rsi
               	movb	$0x0, %al
               	callq	0x40069d <fprintf>
               	movslq	%eax, %rax
               	movl	$0x1, %eax
               	movq	%rax, %rcx
               	movq	(%rsp), %rbx
               	...
               	movslq	%r14d, %r15
               	cmpq	$0xd, %r15
               	je	0x400532 <.text+0x272>
               	movl	$0x2, %r12d
               	movq	%r12, %rdi
               	callq	0x4002d7 <.text+0x17>
               	movq	%rax, %rbx
               	leaq	0xfc71(%rip), %r15      # 0x41016b
               	movslq	%r14d, %r14
               	movq	%rbx, %rdi
               	movq	%r14, %rdx
               	movq	%r15, %rsi
