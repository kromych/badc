...
<.text>:
               	...
               	movslq	%r14d, %rbx
               	cmpq	$0x7, %rbx
               	je	0x4004bc <.text+0x1fc>
               	movl	$0x2, %r15d
               	movq	%r15, %rdi
               	callq	0x4002d7 <.text+0x17>
               	movq	%rax, %rbx
               	leaq	0xfcd9(%rip), %r12      # 0x410158
               	movslq	%r14d, %r15
               	movq	%rbx, %rdi
               	movq	%r15, %rdx
               	movq	%r12, %rsi
               	movb	$0x0, %al
               	callq	0x4006bd <fprintf>
               	movslq	%eax, %rax
               	movl	$0x1, %eax
               	movq	%rax, %rcx
               	movq	(%rsp), %rbx
               	...
               	movslq	%r15d, %r14
               	cmpq	$0xd, %r14
               	je	0x400553 <.text+0x293>
               	movl	$0x2, %r10d
               	movq	%r10, 0x28(%rsp)
               	movq	0x28(%rsp), %rdi
               	callq	0x4002d7 <.text+0x17>
               	movq	%rax, %r14
               	leaq	0xfc52(%rip), %r12      # 0x41016b
               	movslq	%r15d, %rbx
               	movq	%r14, %rdi
               	movq	%rbx, %rdx
               	movq	%r12, %rsi
