...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400496 <.text+0x216>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x40048d <.text+0x20d>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400491 <.text+0x211>
               	andb	%ch, 0x74(%rax)
               	je	0x4004a1 <.text+0x221>
               	jae	0x40046d <.text+0x1ed>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400552 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400549 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40054d <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x40055d <exit+0x40>
               	jae	0x400529 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xfbc3(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xfbc5(%rip)           # 0x4100e8
