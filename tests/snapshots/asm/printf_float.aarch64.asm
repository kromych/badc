...
printf_float.aarch64:	file format elf64-littleaarch64
...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406af0 <exit+0x6500>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8b80
               	tbz	w21, #0x6, 0x3feb44
               	<unknown>
               	cbnz	w16, 0x46eaec
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406bb4 <exit+0x65c4>
               	<unknown>
               	<unknown>
               	<unknown>
