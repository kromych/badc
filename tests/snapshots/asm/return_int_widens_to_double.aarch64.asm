...
<.text>:
               	...
               	stur	x15, [x29, #-0x8]
               	ldur	x14, [x29, #-0x8]
               	mov	x15, #0x900000000000    // =158329674399744
               	movk	x15, #0x407f, lsl #48
               	fmov	d0, x14
               	fmov	d1, x15
               	fcmp	d0, d1
               	cset	x13, ne
               	cbz	x13, 0x4004a8 <.text+0x1e8>
               	mov	x15, #0x1               // =1
               	mov	x0, x15
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
               	...
               	ret
               	ldur	x13, [x29, #-0x8]
               	mov	x15, #0x800000000000    // =140737488355328
               	movk	x15, #0x407f, lsl #48
               	fmov	d0, x13
               	fmov	d1, x15
               	fcmp	d0, d1
               	cset	x14, mi
               	stur	x14, [x29, #-0x38]
               	cbnz	x14, 0x4004f0 <.text+0x230>
               	ldur	x15, [x29, #-0x8]
               	mov	x14, #0xa00000000000    // =175921860444160
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406c80 <exit+0x6500>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8d10
               	tbz	w21, #0x6, 0x3fecd4
               	<unknown>
               	cbnz	w16, 0x46ec7c
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406d44 <exit+0x65c4>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8dd4
               	tbz	w21, #0x6, 0x3fed98
               	<unknown>
               	cbnz	w16, 0x46ed40
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
