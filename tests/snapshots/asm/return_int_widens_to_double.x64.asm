...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40076e <.text+0x4ae>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400765 <.text+0x4a5>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400769 <.text+0x4a9>
               	andb	%ch, 0x74(%rax)
               	je	0x400779 <.text+0x4b9>
               	jae	0x400745 <.text+0x485>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400832 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400829 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40082d <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x40083d <exit+0x3a>
               	jae	0x400809 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf8e3(%rip)           # 0x4100e0

<memcpy>:
               	jmpq	*0xf8e5(%rip)           # 0x4100e8

<exit>:
               	jmpq	*0xf8e7(%rip)           # 0x4100f0
