...
<main>:
               	...
               	xorq	%rcx, %rcx
               	movl	$0x20, %edx
               	movabsq	$-0x112053135014111, %rsi # imm = 0xFEEDFACECAFEBEEF
               	movl	$0x11223344, %r8d       # imm = 0x11223344
               	movl	$0x55667788, %r9d       # imm = 0x55667788
               	...
               	movq	%rax, %gs:(%r9)
               	movl	$0x40, %eax
               	movabsq	$0x7777777777777777, %r9 # imm = 0x7777777777777777
               	movq	%r9, %gs:(%rax)
               	leaq	-0x40(%rbp), %rax
               	movq	%gs:(%rcx), %r9
               	movq	%r9, (%rax)
