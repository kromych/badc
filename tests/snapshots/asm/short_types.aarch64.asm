...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x407270 <exit+0x650c>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9300
               	tbz	w21, #0x6, 0x3ff2c4
               	<unknown>
               	cbnz	w16, 0x46f26c
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x400878 <.text+0x5f8>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x407334 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f93c4
               	tbz	w21, #0x6, 0x3ff388
               	<unknown>
               	cbnz	w16, 0x46f330
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40093c <.text+0x6bc>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
