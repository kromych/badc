...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400d32 <.text+0xab2>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400d29 <.text+0xaa9>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400d2d <.text+0xaad>
               	andb	%ch, 0x74(%rax)
               	je	0x400d3d <.text+0xabd>
               	jae	0x400d09 <.text+0xa89>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400df2 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400de9 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400ded <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x400dfd <exit+0x40>
               	jae	0x400dc9 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf323(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xf325(%rip)           # 0x4100e8
