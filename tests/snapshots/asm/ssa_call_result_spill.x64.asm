...
<.text>:
               	...
               	xorq	%r11, %r11
               	movl	%r11d, -0x48(%rbp)
               	jmp	0x400377 <.text+0x157>
               	movslq	-0x48(%rbp), %r11
               	cmpq	$0x4, %r11
               	jge	0x400439 <.text+0x219>
