...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x407360 <exit+0x650c>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f93f0
               	tbz	w21, #0x6, 0x3ff3b4
               	<unknown>
               	cbnz	w16, 0x46f35c
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x400968 <.text+0x6e8>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x407424 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f94b4
               	tbz	w21, #0x6, 0x3ff478
               	<unknown>
               	cbnz	w16, 0x46f420
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x400a2c <.text+0x7ac>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
