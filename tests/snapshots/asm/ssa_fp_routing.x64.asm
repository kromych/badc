...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4010de <.text+0xe5e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4010d5 <.text+0xe55>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4010d9 <.text+0xe59>
               	andb	%ch, 0x74(%rax)
               	je	0x4010e9 <.text+0xe69>
               	jae	0x4010b5 <.text+0xe35>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4011a2 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x401199 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40119d <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x4011ad <exit+0x40>
               	jae	0x401179 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xef73(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xef75(%rip)           # 0x4100e8
