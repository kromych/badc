...
<.text>:
               	...
               	movq	%r14, 0x10(%rsp)
               	movq	%r15, 0x18(%rsp)
               	leaq	0xfd2b(%rip), %rbx      # 0x410160
               	leaq	0xfd1c(%rip), %r12      # 0x410158
               	movq	(%r12), %r14
               	movq	%r14, %xmm0
               	movq	%rbx, %rdi
               	movb	$0x1, %al
               	callq	0x4006ed <printf>
               	movslq	%eax, %rax
               	movq	%rax, %rdi
               	movabsq	$0x407f900000000000, %r10 # imm = 0x407F900000000000
               	movq	%r10, 0x28(%rsp)
               	leaq	0xfcf9(%rip), %rbx      # 0x410164
               	movsd	0x28(%rsp), %xmm0
               	movq	%rbx, %rdi
               	movb	$0x1, %al
               	callq	0x4006ed <printf>
               	movslq	%eax, %rax
               	movq	%rax, %r14
               	leaq	0xfcdd(%rip), %rbx      # 0x410168
               	leaq	0xfcbe(%rip), %r14      # 0x410150
               	movq	(%r14), %r15
               	movq	(%r12), %r14
               	movq	%r15, %xmm0
               	movq	%r14, %xmm1
