...
<.text>:
               	...
               	stur	w15, [x29, #-0x8]
               	mov	x14, #0x1               // =1
               	cbz	x14, 0x400400 <.text+0x180>
               	sub	x15, x29, #0x8
               	ldrsw	x14, [x15]
               	add	x13, x14, #0x1
               	str	w13, [x15]
               	b	0x400400 <.text+0x180>
               	mov	x13, #0x1               // =1
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406a8c <exit+0x6508>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8b1c
               	tbz	w21, #0x6, 0x3feae0
               	<unknown>
               	cbnz	w16, 0x46ea88
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406b54 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
