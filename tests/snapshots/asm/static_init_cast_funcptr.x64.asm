...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4007fe <.text+0x4fe>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4007f5 <.text+0x4f5>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4007f9 <.text+0x4f9>
               	andb	%ch, 0x74(%rax)
               	je	0x400809 <.text+0x509>
               	jae	0x4007d5 <.text+0x4d5>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4008c2 <exit+0x29>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4008b9 <exit+0x20>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4008bd <exit+0x24>
               	andb	%ch, 0x74(%rax)
               	je	0x4008cd <exit+0x34>
               	jae	0x400899 <exit>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
