...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406b7c <exit+0x6508>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8c0c
               	tbz	w21, #0x6, 0x3febd0
               	<unknown>
               	cbnz	w16, 0x46eb78
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406c44 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8cd4
               	tbz	w21, #0x6, 0x3fec98
               	<unknown>
               	cbnz	w16, 0x46ec40
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
