...
<.text>:
               	...
               	ldp	x29, x30, [sp], #0x10
               	ret
               	mov	x14, #0x3210            // =12816
               	movk	x14, #0x7654, lsl #16
               	movk	x14, #0xba98, lsl #32
               	movk	x14, #0xfedc, lsl #48
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406d6c <exit+0x64fc>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8dfc
               	tbz	w21, #0x6, 0x3fedc0
               	<unknown>
               	cbnz	w16, 0x46ed68
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406e34 <exit+0x65c4>
               	<unknown>
               	<unknown>
               	<unknown>
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40043c <.text+0x17c>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
