...
<plain>:
               	...
               	mov	x1, #0x0                // =0
               	mov	x4, #0xd70b             // =55051
               	movk	x4, #0x70a3, lsl #16
               	movk	x4, #0xa3d, lsl #32
               	movk	x4, #0xa3d7, lsl #48
               	mov	x10, #0x64              // =100
               	mov	x11, #0x5555555555555555 // =6148914691236517205
               	adrp	x5, <page>
               	add	x5, x5, <lo12>
...
<converted>:
               	...
               	mov	x1, #0x0                // =0
               	mov	x9, #0x3e8              // =1000
               	mov	x10, #0x4dd3            // =19923
               	movk	x10, #0x1062, lsl #16
               	adrp	x5, <page>
               	add	x5, x5, <lo12>
               	b	<addr>
               	mov	x0, #0x3e8              // =1000
               	...
               	mov	x1, #0x0                // =0
               	mov	x4, #0xe38f             // =58255
               	movk	x4, #0x8e38, lsl #16
               	movk	x4, #0x38e3, lsl #32
               	movk	x4, #0xe38e, lsl #48
               	mov	x7, #0x9                // =9
               	adrp	x5, <page>
               	add	x5, x5, <lo12>
               	b	<addr>
