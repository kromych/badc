...
<wides>:
               	...
               	mov	x3, #0x0                // =0
               	mov	x6, #0xf7cf             // =63439
               	movk	x6, #0xe353, lsl #16
               	movk	x6, #0x9ba5, lsl #32
               	movk	x6, #0x20c4, lsl #48
               	...
               	str	w1, [x0]
               	mov	x0, #0x0                // =0
               	mov	x5, #-0x7fffffffffffffff // =-9223372036854775807
