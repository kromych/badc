...
<ints>:
               	...
               	cmpl	$0x18, %eax
               	jge	<addr>
               	movq	$-0x7fffffff, %rdi      # imm = 0x80000001
               	movl	%edi, -0x58(%rbp)
               	leaq	<rip>, %rcx
               	movq	(%rcx,%rax,8), %rcx
               	movslq	%ecx, %rcx
               	...
               	movq	(%rcx,%rax,8), %rcx
               	movl	%ecx, %edx
               	imulq	$0x24924925, %rdx, %r8  # imm = 0x24924925
               	movq	%r8, %rsi
               	shrq	$0x20, %rsi
               	movq	%rdx, %r9
               	subq	%rsi, %r9
...
<wides>:
               	...
               	cmpq	%r11, %rcx
               	je	<addr>
               	movabsq	$0x7fffffff80000001, %rdi # imm = 0x7FFFFFFF80000001
               	pushq	%rax
               	pushq	%rdx
               	movq	%rcx, %rax
               	imulq	%rdi
               	...
               	cmpq	%r11, %rcx
               	je	<addr>
               	movabsq	$0x3fffffff80000001, %rsi # imm = 0x3FFFFFFF80000001
               	pushq	%rax
               	pushq	%rdx
               	movq	%rcx, %rax
               	mulq	%rsi
