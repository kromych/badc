...
<fill>:
               	...
               	movq	$0x2, 0x18(%rcx)
               	movq	$-0x2, 0x20(%rcx)
               	movq	$0x7fffffff, 0x28(%rcx) # imm = 0x7FFFFFFF
               	movq	$-0x80000000, 0x30(%rcx) # imm = 0x80000000
               	movabsq	$0x7fffffffffffffff, %rdx # imm = 0x7FFFFFFFFFFFFFFF
               	movq	%rdx, 0x38(%rcx)
               	movabsq	$-0x8000000000000000, %rdx # imm = 0x8000000000000000
               	movq	%rdx, 0x40(%rcx)
               	movq	$0x3b9aca07, 0x48(%rcx) # imm = 0x3B9ACA07
               	movq	$-0x3b9aca07, 0x50(%rcx) # imm = 0xC46535F9
...
<main>:
               	...
               	leaq	<rip>, %rdx
               	movslq	(%rdx,%rcx,4), %rdx
               	imulq	$0x66666667, %rdx, %rdi # imm = 0x66666667
               	movq	%rdi, %rsi
               	sarq	$0x21, %rsi
               	movq	%rsi, %r8
               	shrq	$0x3f, %r8
               	...
               	leaq	<rip>, %rdx
               	movslq	(%rdx,%rcx,4), %rdx
               	imulq	$0x2aaaaaab, %rdx, %rdi # imm = 0x2AAAAAAB
               	movq	%rdi, %rsi
               	sarq	$0x20, %rsi
               	movq	%rsi, %r8
               	shrq	$0x3f, %r8
               	...
               	leaq	<rip>, %rdx
               	movslq	(%rdx,%rcx,4), %rdx
               	imulq	$0x51eb851f, %rdx, %rdi # imm = 0x51EB851F
               	movq	%rdi, %rsi
               	sarq	$0x25, %rsi
               	movq	%rsi, %r8
               	shrq	$0x3f, %r8
               	...
               	leaq	<rip>, %rdx
               	movslq	(%rdx,%rcx,4), %rdx
               	imulq	$0x10624dd3, %rdx, %rdi # imm = 0x10624DD3
               	movq	%rdi, %rsi
               	sarq	$0x26, %rsi
               	movq	%rsi, %r8
               	shrq	$0x3f, %r8
               	...
               	leaq	<rip>, %rdx
               	movslq	(%rdx,%rcx,4), %rdx
               	imulq	$0x7fff8001, %rdx, %rdi # imm = 0x7FFF8001
               	movq	%rdi, %rsi
               	sarq	$0x2f, %rsi
               	movq	%rsi, %r8
               	shrq	$0x3f, %r8
               	...
               	leaq	<rip>, %rdx
               	movslq	(%rdx,%rcx,4), %rdx
               	imulq	$0x40000001, %rdx, %rdi # imm = 0x40000001
               	movq	%rdi, %rsi
               	sarq	$0x3d, %rsi
               	movq	%rsi, %r8
               	shrq	$0x3f, %r8
               	...
               	leaq	<rip>, %rdx
               	movslq	(%rdx,%rcx,4), %rdx
               	imulq	$0x51eb851f, %rdx, %r8  # imm = 0x51EB851F
               	movq	%r8, %rsi
               	sarq	$0x25, %rsi
               	movq	%rsi, %r9
               	shrq	$0x3f, %r9
               	...
               	xorl	%r8d, %r8d
               	subq	%rsi, %r8
               	imulq	$-0x3b9aca07, %r8, %rsi # imm = 0xC46535F9
               	movq	%rdx, %r8
               	subq	%rsi, %r8
               	movq	-0x80(%rbp), %rsi
               	pushq	%rax
