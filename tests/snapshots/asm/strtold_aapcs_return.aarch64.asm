...
<.text>:
               	...
               	bl	0x400820 <__trunctfdf2>
               	fmov	x0, d0
               	mov	x24, #0x4090000000000000 // =4652218415073722368
               	fmov	d0, x24
               	fneg	d7, d0
               	fmov	d0, x0
               	fcmp	d0, d7
               	cset	x0, ne
               	cbz	x0, 0x4005ec <.text+0x2ac>
               	mov	x24, #0x3               // =3
               	mov	x0, x24
               	ldr	x20, [sp]
               	ldr	x21, [sp, #0x8]
