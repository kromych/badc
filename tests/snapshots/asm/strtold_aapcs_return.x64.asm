...
<.text>:
               	...
               	movq	%r14, 0x10(%rsp)
               	movq	%r15, 0x18(%rsp)
               	leaq	0xfcfd(%rip), %rbx      # 0x410158
               	xorq	%r12, %r12
               	movq	%rbx, %rdi
               	movq	%r12, %rsi
               	xorl	%eax, %eax
               	callq	0x40081d <strtold>
               	subq	$0x10, %rsp
               	fstpl	(%rsp)
               	movq	(%rsp), %r14
               	addq	$0x10, %rsp
               	leaq	0xfcdc(%rip), %r15      # 0x410163
               	movq	%r15, %rdi
               	movq	%r12, %rsi
               	xorl	%eax, %eax
               	callq	0x40081d <strtold>
               	...
               	retq
               	leaq	-0x38(%rbp), %r12
               	leaq	0xfb63(%rip), %rbx      # 0x410180
               	movq	%r14, %xmm0
               	movq	%r12, %rdi
               	movq	%rbx, %rsi
               	movb	$0x1, %al
               	callq	0x400823 <sprintf>
               	movslq	%eax, %rax
               	movslq	%eax, %rax
               	cmpq	$0x0, %rax
               	jg	0x400669 <.text+0x369>
               	movl	$0x4, %ebx
               	movq	%rbx, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
