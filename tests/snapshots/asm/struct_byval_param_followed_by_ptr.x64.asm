...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400732 <.text+0x472>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400729 <.text+0x469>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40072d <.text+0x46d>
               	andb	%ch, 0x74(%rax)
               	je	0x40073d <.text+0x47d>
               	jae	0x400709 <.text+0x449>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4007f2 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4007e9 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4007ed <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x4007fd <exit+0x3a>
               	jae	0x4007c9 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf923(%rip)           # 0x4100e0

<printf>:
               	jmpq	*0xf925(%rip)           # 0x4100e8

<exit>:
               	jmpq	*0xf927(%rip)           # 0x4100f0
