...
<.text>:
               	...
               	popq	%rbp
               	retq
               	leaq	0xfcaa(%rip), %rax      # 0x410148
               	movq	%rax, %r12
               	addq	$0x4, %r12
               	movslq	(%r12), %rax
               	cmpq	$0x16, %rax
               	je	0x4004d6 <.text+0x256>
               	movl	$0x2, %eax
               	movq	%rax, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
               	...
               	popq	%rbp
               	retq
               	leaq	0xfc6b(%rip), %r12      # 0x410148
               	movq	%r12, %rax
               	addq	$0x8, %rax
               	movslq	(%rax), %r12
               	cmpq	$0x21, %r12
               	je	0x400515 <.text+0x295>
               	movl	$0x3, %r12d
               	movq	%r12, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
               	...
               	popq	%rbp
               	retq
               	leaq	0xfc2c(%rip), %rax      # 0x410148
               	movq	%rax, %r12
               	addq	$0xc, %r12
               	movslq	(%r12), %rax
               	cmpq	$0x2c, %rax
               	je	0x400554 <.text+0x2d4>
               	movl	$0x4, %eax
               	movq	%rax, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
