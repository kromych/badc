...
<.text>:
               	...
               	popq	%rbp
               	retq
               	leaq	0xfc64(%rip), %r12      # 0x410148
               	movq	%r12, %r8
               	addq	$0x8, %r8
               	movslq	(%r8), %r12
               	cmpq	$0x21, %r12
               	je	0x40051c <.text+0x29c>
               	movl	$0x3, %r12d
               	movq	%r12, %rcx
               	movq	(%rsp), %rbx
               	movq	0x8(%rsp), %r12
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400636 <.text+0x3b6>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x40062d <.text+0x3ad>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400631 <.text+0x3b1>
               	andb	%ch, 0x74(%rax)
               	je	0x400641 <.text+0x3c1>
               	jae	0x40060d <.text+0x38d>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4006f2 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4006e9 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4006ed <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x4006fd <exit+0x40>
               	jae	0x4006c9 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
