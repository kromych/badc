...
<.text>:
               	...
               	movq	%r14, 0x10(%rsp)
               	movq	%r15, 0x18(%rsp)
               	leaq	0xfa42(%rip), %rbx      # 0x410150
               	leaq	0xfa63(%rip), %r12      # 0x410178
               	movq	%rbx, %rdi
               	movq	%r12, %rsi
               	callq	0x40040e <.text+0x14e>
               	movslq	%eax, %r12
               	cmpq	$0x0, %r12
               	je	0x4007c3 <.text+0x503>
               	leaq	0xfa46(%rip), %r14      # 0x41017d
               	movslq	%eax, %rbx
               	leaq	0xfa0f(%rip), %rax      # 0x410150
               	movq	%rax, %rdi
               	addq	$0x8, %rdi
               	movq	(%rdi), %r12
               	movq	%rax, %rdi
