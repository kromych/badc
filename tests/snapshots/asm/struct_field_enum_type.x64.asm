...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40059a <.text+0x31a>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400591 <.text+0x311>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400595 <.text+0x315>
               	andb	%ch, 0x74(%rax)
               	je	0x4005a5 <.text+0x325>
               	jae	0x400571 <.text+0x2f1>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400652 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400649 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40064d <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x40065d <exit+0x40>
               	jae	0x400629 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xfac3(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xfac5(%rip)           # 0x4100e8
