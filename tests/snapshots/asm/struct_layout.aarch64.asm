...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x4072b0 <exit+0x650c>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f9340
               	tbz	w21, #0x6, 0x3ff304
               	<unknown>
               	cbnz	w16, 0x46f2ac
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x4008b8 <.text+0x638>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x407374 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40097c <.text+0x6fc>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
