...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400eea <.text+0xc6a>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400ee1 <.text+0xc61>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400ee5 <.text+0xc65>
               	andb	%ch, 0x74(%rax)
               	je	0x400ef5 <.text+0xc75>
               	jae	0x400ec1 <.text+0xc41>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400fa2 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400f99 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400f9d <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x400fad <exit+0x40>
               	jae	0x400f79 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf173(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xf175(%rip)           # 0x4100e8
