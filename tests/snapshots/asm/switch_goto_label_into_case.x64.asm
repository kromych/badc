...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400622 <.text+0x402>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400619 <.text+0x3f9>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40061d <.text+0x3fd>
               	andb	%ch, 0x74(%rax)
               	je	0x40062d <.text+0x40d>
               	jae	0x4005f9 <.text+0x3d9>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4006e2 <exit+0x3b>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4006d9 <exit+0x32>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4006dd <exit+0x36>
               	andb	%ch, 0x74(%rax)
               	je	0x4006ed <exit+0x46>
               	jae	0x4006b9 <exit+0x12>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
