...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400876 <.text+0x5b6>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x40086d <.text+0x5ad>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400871 <.text+0x5b1>
               	andb	%ch, 0x74(%rax)
               	je	0x400881 <.text+0x5c1>
               	jae	0x40084d <.text+0x58d>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400932 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400929 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40092d <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x40093d <exit+0x3a>
               	jae	0x400909 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf7e3(%rip)           # 0x4100e0

<fprintf>:
               	jmpq	*0xf7e5(%rip)           # 0x4100e8

<exit>:
               	jmpq	*0xf7e7(%rip)           # 0x4100f0
