...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406bc0 <exit+0x650c>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8c50
               	tbz	w21, #0x6, 0x3fec14
               	<unknown>
               	cbnz	w16, 0x46ebbc
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406c84 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8d14
               	tbz	w21, #0x6, 0x3fecd8
               	<unknown>
               	cbnz	w16, 0x46ec80
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
