...
<.text>:
               	...
               	fcmp	d0, d7
               	cset	x13, mi
               	cbz	x13, 0x4004f8 <.text+0x278>
               	mov	x14, #0x3fe0000000000000 // =4602678819172646912
               	fmov	d0, x14
               	fneg	d7, d0
               	fmov	x16, d7
               	stur	x16, [x29, #-0x40]
               	b	0x400504 <.text+0x284>
               	...
               	fcmp	d0, d7
               	cset	x13, mi
               	cbz	x13, 0x4005e0 <.text+0x360>
               	mov	x14, #0x3fe0000000000000 // =4602678819172646912
               	fmov	d0, x14
               	fneg	d7, d0
               	fmov	x16, d7
               	stur	x16, [x29, #-0x50]
               	b	0x4005ec <.text+0x36c>
               	mov	x13, #0x3fe0000000000000 // =4602678819172646912
               	stur	x13, [x29, #-0x50]
               	b	0x4005ec <.text+0x36c>
               	ldur	x13, [x29, #-0x50]
               	...
               	fcmp	d0, d7
               	cset	x0, mi
               	cbz	x0, 0x400680 <.text+0x400>
               	mov	x13, #0x3fe0000000000000 // =4602678819172646912
               	fmov	d0, x13
               	fneg	d7, d0
               	fmov	x16, d7
               	stur	x16, [x29, #-0x58]
               	b	0x40068c <.text+0x40c>
               	mov	x0, #0x3fe0000000000000 // =4602678819172646912
               	stur	x0, [x29, #-0x58]
               	b	0x40068c <.text+0x40c>
               	ldur	x0, [x29, #-0x58]
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406d68 <exit+0x6504>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8df8
               	tbz	w21, #0x6, 0x3fedbc
               	<unknown>
               	cbnz	w16, 0x46ed64
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406e34 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8ec4
               	tbz	w21, #0x6, 0x3fee88
               	<unknown>
               	cbnz	w16, 0x46ee30
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40043c <.text+0x1bc>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
