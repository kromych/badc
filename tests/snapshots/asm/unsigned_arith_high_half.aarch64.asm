...
unsigned_arith_high_half.aarch64:	file format elf64-littleaarch64
...
<.text>:
               	...
               	ldp	x29, x30, [sp], #0x10
               	ret
               	mov	x15, #0xff00            // =65280
               	movk	x15, #0xff00, lsl #16
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406b24 <exit+0x6510>
               	<unknown>
               	<unknown>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x406be4 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
