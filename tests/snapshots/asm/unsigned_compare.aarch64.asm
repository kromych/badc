...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x406f60 <exit+0x6500>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f8ff0
               	tbz	w21, #0x6, 0x3fefb4
               	<unknown>
               	cbnz	w16, 0x46ef5c
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x400568 <.text+0x2a8>
               	<unknown>
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x407024 <exit+0x65c4>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3f90b4
               	tbz	w21, #0x6, 0x3ff078
               	<unknown>
               	cbnz	w16, 0x46f020
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40062c <.text+0x36c>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
