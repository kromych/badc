...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4005ce <.text+0x34e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4005c5 <.text+0x345>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4005c9 <.text+0x349>
               	andb	%ch, 0x74(%rax)
               	je	0x4005d9 <.text+0x359>
               	jae	0x4005a5 <.text+0x325>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400692 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400689 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40068d <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x40069d <exit+0x40>
               	jae	0x400669 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xfa83(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xfa85(%rip)           # 0x4100e8
