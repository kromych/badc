...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40068e <.text+0x3ce>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400685 <.text+0x3c5>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x400689 <.text+0x3c9>
               	andb	%ch, 0x74(%rax)
               	je	0x400699 <.text+0x3d9>
               	jae	0x400665 <.text+0x3a5>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400752 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400749 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40074d <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x40075d <exit+0x3a>
               	jae	0x400729 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xf9c3(%rip)           # 0x4100e0

<printf>:
               	jmpq	*0xf9c5(%rip)           # 0x4100e8

<exit>:
               	jmpq	*0xf9c7(%rip)           # 0x4100f0
