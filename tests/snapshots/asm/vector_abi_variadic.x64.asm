...
<main>:
               	...
               	leaq	-0x60(%rbp), %r15
               	movabsq	$0x3fe8000000000000, %r10 # imm = 0x3FE8000000000000
               	movq	%r10, 0x68(%rsp)
               	movl	$0x3, %edi
               	callq	<addr>
               	...
               	leaq	-0x50(%rbp), %r10
               	movq	%r10, 0x60(%rsp)
               	movabsq	$0x3ff0000000000000, %r10 # imm = 0x3FF0000000000000
               	movq	%r10, 0x58(%rsp)
               	movl	$0x4, %edi
               	callq	<addr>
               	...
               	leaq	-0x40(%rbp), %r10
               	movq	%r10, 0x50(%rsp)
               	movabsq	$0x3ff4000000000000, %r10 # imm = 0x3FF4000000000000
               	movq	%r10, 0x48(%rsp)
               	movl	$0x5, %edi
               	callq	<addr>
               	movsd	%xmm0, -0x30(%rbp,%riz)
