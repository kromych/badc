...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4006c6 <.text+0x406>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4006bd <.text+0x3fd>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4006c1 <.text+0x401>
               	andb	%ch, 0x74(%rax)
               	je	0x4006d1 <.text+0x411>
               	jae	0x40069d <.text+0x3dd>
               	<unknown>
               	<unknown>
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x400782 <exit+0x2f>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x400779 <exit+0x26>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40077d <exit+0x2a>
               	andb	%ch, 0x74(%rax)
               	je	0x40078d <exit+0x3a>
               	jae	0x400759 <exit+0x6>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
