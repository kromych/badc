...
<.text>:
               	...
               	<unknown>
               	tbz	w0, #0x6, 0x408258 <exit+0x6504>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3fa2e8
               	tbz	w21, #0x6, 0x4002ac <.text+0x2c>
               	<unknown>
               	cbnz	w16, 0x470254
               	<unknown>
               	...
               	<unknown>
               	cbhs	w5, w8, 0x401860 <.text+0x15e0>
               	<unknown>
		...
		...
               	...
               	mla	v10.8h, v8.8h, v3.h[6]
               	<unknown>
               	tbz	w0, #0x6, 0x408324 <exit+0x65d0>
               	<unknown>
               	<unknown>
               	<unknown>
               	tbz	w18, #0xc, 0x3fa3b4
               	tbz	w21, #0x6, 0x400378 <.text+0xf8>
               	<unknown>
               	cbnz	w16, 0x470320
               	<unknown>
               	adds	w3, w19, #0x84c, lsl #12 // =0x84c000
               	...
               	ands	w1, w19, #0x3800000
               	<unknown>
               	cbhs	w5, w8, 0x40192c <.text+0x16ac>
               	<unknown>
               	ldpsw	x15, x11, [x25, #-0xc8]
               	<unknown>
               	ldp	d14, d24, [x25, #-0x110]
