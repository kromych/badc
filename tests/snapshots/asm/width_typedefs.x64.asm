...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4004ee <.text+0x26e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4004e5 <.text+0x265>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4004e9 <.text+0x269>
               	andb	%ch, 0x74(%rax)
               	je	0x4004f9 <.text+0x279>
               	jae	0x4004c5 <.text+0x245>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x4005b2 <exit+0x35>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x4005a9 <exit+0x2c>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x4005ad <exit+0x30>
               	andb	%ch, 0x74(%rax)
               	je	0x4005bd <exit+0x40>
               	jae	0x400589 <exit+0xc>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
               	insl	%dx, %es:(%rdi)
...
<dlsym>:
               	jmpq	*0xfb63(%rip)           # 0x4100e0

<exit>:
               	jmpq	*0xfb65(%rip)           # 0x4100e8
