...
<main>:
               	...
               	leaq	-0x728(%rbp), %rcx
               	movw	$0xffff, 0xa(%rcx)      # imm = 0xFFFF
               	movw	$0xffff, 0xc(%rcx)      # imm = 0xFFFF
               	movw	$0xffff, 0xe(%rcx)      # imm = 0xFFFF
               	pushq	%rax
               	movq	(%rcx), %rax
               	movq	%rax, (%rdx)
               	movq	0x8(%rcx), %rax
