...
<.text>:
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x40147e <.text+0x113e>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x401475 <.text+0x1135>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x401479 <.text+0x1139>
               	andb	%ch, 0x74(%rax)
               	je	0x401489 <.text+0x1149>
               	jae	0x401455 <.text+0x1115>
               	<unknown>
               	<unknown>
		...
		...
               	...
               	movslq	0x67(%rsi), %esp
               	popq	%rdi
               	jae	0x401542 <exit+0x23>
               	<unknown>
               	orb	(%rcx), %cl
               	jb	0x401539 <exit+0x1a>
               	insl	%dx, %es:(%rdi)
               	outsl	(%rsi), %dx
               	je	0x40153d <exit+0x1e>
               	andb	%ch, 0x74(%rax)
               	je	0x40154d <exit+0x2e>
               	jae	0x401519 <printf>
               	<unknown>
               	<unknown>
               	imull	$0x6f632e62, 0x75(%eax,%ebp,2), %esi # imm = 0x6F632E62
...
<dlsym>:
               	jmpq	*0xebd3(%rip)           # 0x4100e0

<fprintf>:
               	jmpq	*0xebd5(%rip)           # 0x4100e8

<atoi>:
               	jmpq	*0xebd7(%rip)           # 0x4100f0

<printf>:
               	jmpq	*0xebd9(%rip)           # 0x4100f8

<exit>:
               	jmpq	*0xebdb(%rip)           # 0x410100
